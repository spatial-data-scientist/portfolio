 ...
 * v2.10.1
 */
import { r as registerInstance, h, F as Fragment, g as getElement, c as createEvent, f as forceUpdate } from './index-c69832bf.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-fbd11a84.js';
import { b as slotChangeHasAssignedElement, s as slotChangeGetAssignedElements, e as getSlotted, g as getElementDir, l as isPrimaryPointerButton } from './dom-5badf0bf.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-2274ef15.js';
import { c as clamp } from './math-1c4eaaa4.js';
...
const Shell = class {
    ...
    render() {
        return (h(Fragment, { key: 'd5ca9178c4e9c74dae958a6105655a5d30de1584' }, this.renderHeader(), this.renderMain(), this.renderFooter(), this.renderPositionedSlots()));
    }
...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (h("div", { key: '272dced8d569d7cbb822739dea81fc4e66e773f6', class: CSS$1.content }, h("slot", { key: '7eb60d427747c4c05a9c4c64465f8ee0519cf9c2' })));
        ...
        return h(Fragment, { key: 'eba71689b26127da5043ab43bbd746702e59b788' }, children);
    }
    get el() { return getElement(this); }
};
