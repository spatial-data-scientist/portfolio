 ...
 * v2.10.1
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, e as readTask, F as Fragment } from './index-c69832bf.js';
import { C as nodeListToArray, k as focusElementInGroup, g as getElementDir, D as filterDirectChildren, t as toAriaBoolean } from './dom-5badf0bf.js';
import { g as guid } from './guid-13f267a8.js';
import { a as calciteSize24, b as calciteSize32, d as calciteSize44 } from './core-cc8d8866.js';
...
import { c as connectInteractive, d as disconnectInteractive, I as InteractiveContainer, u as updateHostInteraction } from './interactive-81282a6f.js';
...
const Tab = class {
    ...
    render() {
        ...
        return (h(Host, { key: '34f25633afec73b771fba5a8d2c35e647dbc7abe', "aria-labelledby": this.labeledBy, id: id }, h("div", { key: '8ee7f4025cc393cfb3f4d53a6762a50017abbfe8', class: { [CSS$2.container]: true, [`scale-${this.scale}`]: true }, role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, h("section", { key: 'eda53c19a48f0a96b52362a588292139f8526da4', class: CSS$2.content }, h("slot", { key: 'c1da92b857f33df134cbaf5eeddc3f8fcda1f5dc' })))));
    }
    connectedCallback() {
...
const TabNav = class {
    ...
    render() {
        ...
        return (h(Host, { key: '174cd3c34b59be8c237cb1bd2e143d8d9369198c', role: "tablist" }, h("div", { key: '3431edaba38c8875d6077a649610d2f21173df47', class: {
            ...
            }, ref: this.storeContainerRef }, this.renderScrollButton("start"), h("div", { key: '1fee2edb04f475641523b66d5fbe4e62a7403c26', class: {
                [CSS$1.tabTitleSlotWrapper]: true,
            }, onScroll: this.onTabTitleScroll, onWheel: this.onTabTitleWheel, ref: this.storeTabTitleWrapperRef }, h("slot", { key: 'e14eea620096ffa9bc6d518ce31ebe0f623bdf4e', onSlotchange: this.onSlotChange })), h("div", { key: '1ec5cff7490ac9ae87b0dab467ca3890c217a3b3', class: {
                [CSS$1.activeIndicatorContainer]: true,
            }, ref: (el) => (this.activeIndicatorContainerEl = el) }, h("div", { key: 'e0e10bbeedcae6bcf1f5d5957d35e06e555fd14c', class: "tab-nav-active-indicator", ref: (el) => (this.activeIndicatorEl = el), style: indicatorStyle })), this.renderScrollButton("end"))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const TabTitle = class {
    ...
    render() {
        ...
        const iconStartEl = (h("calcite-icon", { key: 'c6c7baa28fe5aa5ed07d85815d0a0ebac4318368', class: { [CSS.titleIcon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: getIconScale(this.scale) }));
        const iconEndEl = (h("calcite-icon", { key: 'fc5e9d925510867e451df60bed298b158a10054b', class: { [CSS.titleIcon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: getIconScale(this.scale) }));
        return (h(Host, { key: 'd84446a2e6fb8a9007c70a798e997d2f8bae485e', "aria-controls": this.controls, "aria-selected": toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected && !this.disabled ? 0 : -1 }, h(InteractiveContainer, { key: '0130123cde98ed0f0e5065387156293fda2d1c4b', disabled: this.disabled }, h("div", { key: 'c37a2e097b38dd17588a7eb81fa4fa2c5f3977a9', class: {
                container: true,
                [CSS.iconPresent]: !!this.iconStart || !!this.iconEnd,
                [`scale-${this.scale}`]: true,
            }, hidden: closed, ref: (el) => this.resizeObserver?.observe(el) }, h("div", { key: '53065b8558e4e0732aaeb60624367547a0aee7f8', class: { [CSS.content]: true, [CSS.contentHasText]: this.hasText } }, this.iconStart ? iconStartEl : null, h("slot", { key: 'c05fdb2126495f59fe88e32b5368e8ad8a79b303' }), this.iconEnd ? iconEndEl : null), this.renderCloseButton()))));
    }
    renderCloseButton() {
...
const Tabs = class {
    ...
    render() {
        return (h(Fragment, { key: '8f47fe2cdeb7897a888891ba33b3fcda0d1d2b10' }, h("slot", { key: 'e19648c5138807be98e46ff6a343989a8d931c86', name: SLOTS.titleGroup }), h("section", { key: '64880a376a2cda485d608ba00fe3431fdb7ea011' }, h("slot", { key: '2cbd9deb8203448212357a4de42f5ac4a1f5daad' }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
