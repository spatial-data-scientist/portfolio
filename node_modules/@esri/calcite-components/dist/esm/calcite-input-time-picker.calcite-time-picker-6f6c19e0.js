...
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-326c9435.js';
import { g as guid } from './guid-13f267a8.js';
import { c as connectInteractive, d as disconnectInteractive, u as updateHostInteraction, I as InteractiveContainer } from './interactive-81282a6f.js';
import { n as numberKeys } from './key-3685937e.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-e3157659.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-1c82fe7c.js';
import { n as numberStringFormatter, e as getDateTimeFormat, i as isValidNumber, b as getSupportedNumberingSystem, g as getSupportedLocale, c as connectLocalized, d as disconnectLocalized } from './locale-2274ef15.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap } from './focusTrapComponent-a4d396cc.js';
import { d as decimalPlaces, g as getDecimals } from './math-1c4eaaa4.js';
import { u as updateMessages, c as connectMessages, s as setUpMessages, d as disconnectMessages } from './t9n-2ba79023.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-2e1b5522.js';
import { g as getIconScale } from './component-f1a729cc.js';
import { V as Validation } from './Validation-04eac16d.js';
import { f as focusFirstTabbable } from './dom-5badf0bf.js';
import { s as syncHiddenFormInput } from './input-fe03bb7b.js';
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => import('./ar-1da8cae2.js')],
    ["bg", () => import('./bg-730755b5.js')],
    ["bs", () => import('./bs-68f80a63.js')],
    ["ca", () => import('./ca-5a24816c.js')],
    ["cs", () => import('./cs-76cbde19.js')],
    ["da", () => import('./da-8855a364.js')],
    ["de", () => import('./de-e5fa77f8.js')],
    ["de-at", () => import('./de-at-67e0bdfe.js')],
    ["de-ch", () => import('./de-ch-6a827ab7.js')],
    ["el", () => import('./el-213c1f06.js')],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => import('./en-au-3809d8c6.js')],
    ["en-ca", () => import('./en-ca-ec4ac747.js')],
    ["en-gb", () => import('./en-gb-b4760ffc.js')],
    ["es", () => import('./es-97355df4.js')],
    ["es-mx", () => import('./es-mx-3f7ca843.js')],
    ["et", () => import('./et-358daf02.js')],
    ["fi", () => import('./fi-170df945.js')],
    ["fr", () => import('./fr-4ad20b54.js')],
    ["fr-ch", () => import('./fr-ch-6071eaf3.js')],
    ["he", () => import('./he-52e54b15.js')],
    ["hi", () => import('./hi-3f2a5df9.js')],
    ["hr", () => import('./hr-72f6ae4f.js')],
    ["hu", () => import('./hu-f588a32d.js')],
    ["id", () => import('./id-db28366b.js')],
    ["it", () => import('./it-6b01af21.js')],
    ["it-ch", () => import('./it-ch-33b5479f.js')],
    ["ja", () => import('./ja-60613101.js')],
    ["ko", () => import('./ko-b85cd544.js')],
    ["lt", () => import('./lt-3f965aea.js')],
    ["lv", () => import('./lv-f21e8b00.js')],
    ["mk", () => import('./mk-62a26965.js')],
    ["nl", () => import('./nl-ebdfa093.js')],
    ["nb", () => import('./nb-5d48cd0f.js')],
    ["pl", () => import('./pl-6d717067.js')],
    ["pt", () => import('./pt-9c0e432a.js')],
    ["pt-br", () => import('./pt-br-dd1f9799.js')],
    ["ro", () => import('./ro-9176d516.js')],
    ["ru", () => import('./ru-d9a3ba00.js')],
    ["sk", () => import('./sk-e87eaa1f.js')],
    ["sl", () => import('./sl-5c9da03b.js')],
    ["sr", () => import('./sr-333f022e.js')],
    ["sv", () => import('./sv-3a8d7b10.js')],
    ["th", () => import('./th-e5b7770c.js')],
    ["tr", () => import('./tr-467d7520.js')],
    ["uk", () => import('./uk-e5161142.js')],
    ["vi", () => import('./vi-20ad0b5f.js')],
    ["zh-cn", () => import('./zh-cn-e2197662.js')],
    ["zh-hk", () => import('./zh-hk-734c995e.js')],
    ["zh-tw", () => import('./zh-tw-1681721f.js')],
]);
...
const InputTimePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: '498bdb0e3641206a9ad2a6d8fd68396a9efc48c0', onBlur: this.hostBlurHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: 'b5f8d328885f383deaa4c00c576b2721e476bdf1', disabled: this.disabled }, h("div", { key: '3a0565405279574e0fb83988f5dac21378a22f19', class: "input-wrapper", onClick: this.onInputWrapperClick }, h("calcite-input-text", { key: 'cfb8045fa55943b2c35df6263e9ca475db602856', "aria-autocomplete": "none", "aria-haspopup": "dialog", disabled: disabled, icon: "clock", id: this.referenceElementId, label: getLabelText(this), lang: this.effectiveLocale, onCalciteInputTextInput: this.calciteInternalInputInputHandler, onCalciteInternalInputTextFocus: this.calciteInternalInputFocusHandler, readOnly: readOnly, ref: this.setInputAndTransitionEl, role: "combobox", scale: this.scale, status: this.status }), !this.readOnly && this.renderToggleIcon(this.open)), h("calcite-popover", { key: 'b1a5f87dc611d156896512a46fccf583ebb976cf', focusTrapDisabled: true, id: dialogId, label: messages.chooseTime, lang: this.effectiveLocale, onCalcitePopoverClose: this.popoverCloseHandler, onCalcitePopoverOpen: this.popoverOpenHandler, open: this.open, overlayPositioning: this.overlayPositioning, placement: this.placement, ref: this.setCalcitePopoverEl, referenceElement: this.referenceElementId, triggerDisabled: true }, h("calcite-time-picker", { key: '4546b850d584d4587e2e4bae0a264f138192b28b', lang: this.effectiveLocale, messageOverrides: this.messageOverrides, numberingSystem: this.numberingSystem, onCalciteInternalTimePickerChange: this.timePickerChangeHandler, ref: this.setCalciteTimePickerEl, scale: this.scale, step: this.step, tabIndex: this.open ? undefined : -1, value: this.value })), h(HiddenFormInputSlot, { key: '86dbe3dab6dfd37222eeb8a36e0806453d718697', component: this }), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
const TimePicker = class {
    ...
    render() {
        ...
        return (h("div", { key: '0b13e9884c7e6795911ece9275702f5f70afc8d8', class: {
                [CSS.timePicker]: true,
                [CSS.showMeridiem]: showMeridiem,
                [CSS.showSecond]: this.showSecond,
                [CSS[`scale-${this.scale}`]]: true,
            }, dir: "ltr" }, h("div", { key: '40a627116c384a11a65bbaaf5359ed56a9b0a954', class: CSS.column, role: "group" }, h("span", { key: '8d14e974bcce95a1715b809d90d152f956613166', "aria-label": this.messages.hourUp, class: {
                [CSS.button]: true,
                [CSS.buttonHourUp]: true,
                [CSS.buttonTopLeft]: true,
            }, onClick: this.hourUpClickHandler, role: "button" }, h("calcite-icon", { key: 'bfacb03ba5eb88301232149d29d1763d909de847', icon: "chevron-up", scale: iconScale })), h("span", { key: 'b2e006317fd8997ca45c8a693a45b0cb34e1c012', "aria-label": this.messages.hour, "aria-valuemax": "23", "aria-valuemin": "1", "aria-valuenow": (hourIsNumber && parseInt(this.hour)) || "0", "aria-valuetext": this.hour, class: {
                [CSS.input]: true,
                [CSS.hour]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.hourEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.hourKeyDownHandler, ref: this.setHourEl, role: "spinbutton", tabIndex: 0 }, this.localizedHour || "--"), h("span", { key: '94e3b7eb596549e4d5e509bc9d6eacc6e814571f', "aria-label": this.messages.hourDown, class: {
                [CSS.button]: true,
                [CSS.buttonHourDown]: true,
                [CSS.buttonBottomLeft]: true,
            }, onClick: this.hourDownClickHandler, role: "button" }, h("calcite-icon", { key: 'e6a6354f3c1528f4d9a7c58f97e763a291404745', icon: "chevron-down", scale: iconScale }))), h("span", { key: 'da9e69c5a2f162704153d2d799689332c6cfe96b', class: CSS.delimiter }, this.localizedHourSuffix), h("div", { key: '538ff4b0daf92d4d1a3bc250c1096303e9343967', class: CSS.column, role: "group" }, h("span", { key: '6df3c2cb459000de7f813f32dc074fb48bf60f55', "aria-label": this.messages.minuteUp, class: {
                [CSS.button]: true,
                [CSS.buttonMinuteUp]: true,
            }, onClick: this.minuteUpClickHandler, role: "button" }, h("calcite-icon", { key: 'ecfb35802542db3da0af57ce1ac6356dc031a248', icon: "chevron-up", scale: iconScale })), h("span", { key: '58a1bbcd49a4cf5d8dbac2362b8d06eefe9841ed', "aria-label": this.messages.minute, "aria-valuemax": "12", "aria-valuemin": "1", "aria-valuenow": (minuteIsNumber && parseInt(this.minute)) || "0", "aria-valuetext": this.minute, class: {
                [CSS.input]: true,
                [CSS.minute]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.minuteEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.minuteKeyDownHandler, ref: this.setMinuteEl, role: "spinbutton", tabIndex: 0 }, this.localizedMinute || "--"), h("span", { key: '70a9b29aa4cd256e58c1a97ea3a8dc8b0a2390c7', "aria-label": this.messages.minuteDown, class: {
                [CSS.button]: true,
                [CSS.buttonMinuteDown]: true,
            }, onClick: this.minuteDownClickHandler, role: "button" }, h("calcite-icon", { key: 'ab7abba85f6b75bb46d6e774a468fb2976cf93c5', icon: "chevron-down", scale: iconScale }))), this.showSecond && h("span", { key: '87793f21ee3c354a25b5d717862fcc60aa258597', class: CSS.delimiter }, this.localizedMinuteSuffix), this.showSecond && (h("div", { key: 'f7f674498673ea4fd01e753b18d01fb43c022690', class: CSS.column, role: "group" }, h("span", { key: 'e29e4cf67839dda1db29122ad2caa440f983368b', "aria-label": this.messages.secondUp, class: {
                [CSS.button]: true,
                [CSS.buttonSecondUp]: true,
            }, onClick: this.secondUpClickHandler, role: "button" }, h("calcite-icon", { key: '2cf5d11dc7b9b6687371b6c46bf753bb7174ef6b', icon: "chevron-up", scale: iconScale })), h("span", { key: 'ed2af614eb1ae9c747d0a91999ff0d47761f3c83', "aria-label": this.messages.second, "aria-valuemax": "59", "aria-valuemin": "0", "aria-valuenow": (secondIsNumber && parseInt(this.second)) || "0", "aria-valuetext": this.second, class: {
                [CSS.input]: true,
                [CSS.second]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.secondEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.secondKeyDownHandler, ref: this.setSecondEl, role: "spinbutton", tabIndex: 0 }, this.localizedSecond || "--"), h("span", { key: '7da3d99f1e8d7e504a6b360f347628cb8201bd19', "aria-label": this.messages.secondDown, class: {
                [CSS.button]: true,
                [CSS.buttonSecondDown]: true,
            }, onClick: this.secondDownClickHandler, role: "button" }, h("calcite-icon", { key: '4b461d08f3d81395cdbeb09cb433f07b3f5d96ad', icon: "chevron-down", scale: iconScale })))), this.showFractionalSecond && (h("span", { key: 'a243778b6ccd13ff93d1cdd36bc95f7f4f30abf3', class: CSS.delimiter }, this.localizedDecimalSeparator)), this.showFractionalSecond && (h("div", { key: '69d58a727a9b9129a86cdf4229607792f405a872', class: CSS.column, role: "group" }, h("span", { key: '52d582ae745c98da28d46250089c717bc9a465e8', "aria-label": this.messages.fractionalSecondUp, class: {
                [CSS.button]: true,
                [CSS.buttonFractionalSecondUp]: true,
            }, onClick: this.fractionalSecondUpClickHandler, role: "button" }, h("calcite-icon", { key: '5f5e04f54beb477106ae636acab8e77c6ac4ceb6', icon: "chevron-up", scale: iconScale })), h("span", { key: '3826e4fcf70095ae262fe2091573de436e15e8f2', "aria-label": this.messages.fractionalSecond, "aria-valuemax": "999", "aria-valuemin": "1", "aria-valuenow": (fractionalSecondIsNumber && parseInt(this.fractionalSecond)) || "0", "aria-valuetext": this.localizedFractionalSecond, class: {
                [CSS.input]: true,
                [CSS.fractionalSecond]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.fractionalSecondEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.fractionalSecondKeyDownHandler, ref: this.setFractionalSecondEl, role: "spinbutton", tabIndex: 0 }, this.localizedFractionalSecond || "--"), h("span", { key: '10eb9f6fc3033f4398dd147e4ad752f041a54c26', "aria-label": this.messages.fractionalSecondDown, class: {
                [CSS.button]: true,
                [CSS.buttonFractionalSecondDown]: true,
            }, onClick: this.fractionalSecondDownClickHandler, role: "button" }, h("calcite-icon", { key: '6a9e74fb67f77bbe6c5f03ad433724305ceaff8d', icon: "chevron-down", scale: iconScale })))), this.localizedSecondSuffix && (h("span", { key: 'c60b3cdc1b6afbc0c579d0f2eae9be9d01b0f8cc', class: CSS.delimiter }, this.localizedSecondSuffix)), showMeridiem && (h("div", { key: '69065ed996cac1ac49ee6e93d15cdb2cb87cb7b9', class: {
                [CSS.column]: true,
                [CSS.meridiemStart]: this.meridiemOrder === 0,
            }, role: "group" }, h("span", { key: '69d653fbec25b856caa75f531e33ef93ee2dd52e', "aria-label": this.messages.meridiemUp, class: {
                [CSS.button]: true,
                [CSS.buttonMeridiemUp]: true,
                [CSS.buttonTopRight]: true,
            }, onClick: this.meridiemUpClickHandler, role: "button" }, h("calcite-icon", { key: 'b5994501a7d83a2d76892802cc6a1290d035b20a', icon: "chevron-up", scale: iconScale })), h("span", { key: '005bbc86ba9cc3e28fba696527c16bbabc9898a8', "aria-label": this.messages.meridiem, "aria-valuemax": "2", "aria-valuemin": "1", "aria-valuenow": (this.meridiem === "PM" && "2") || "1", "aria-valuetext": this.meridiem, class: {
                [CSS.input]: true,
                [CSS.meridiem]: true,
                [CSS.inputFocus]: this.activeEl && this.activeEl === this.meridiemEl,
            }, onClick: this.inputClickHandler, onFocus: this.focusHandler, onKeyDown: this.meridiemKeyDownHandler, ref: this.setMeridiemEl, role: "spinbutton", tabIndex: 0 }, this.localizedMeridiem || "--"), h("span", { key: '74bf7d0880945afa9b15d518d39da2217efac32f', "aria-label": this.messages.meridiemDown, class: {
                [CSS.button]: true,
                [CSS.buttonMeridiemDown]: true,
                [CSS.buttonBottomRight]: true,
            }, onClick: this.meridiemDownClickHandler, role: "button" }, h("calcite-icon", { key: '3c2b9a5f00d2eb194166814ef32ffdf5077f177a', icon: "chevron-down", scale: iconScale }))))));
    }
    static get delegatesFocus() { return true; }
    static get assetsDirs() { return ["assets"]; }
    get el() { return getElement(this); }
...
//# sourceMappingURL=calcite-input-time-picker.calcite-time-picker-6f6c19e0.js.map