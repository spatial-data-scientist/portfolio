 ...
 * v2.10.1
 */
import { r as registerInstance, f as forceUpdate, h, H as Host, g as getElement, c as createEvent, F as Fragment } from './index-c69832bf.js';
import { s as slotChangeGetAssignedElements, k as focusElementInGroup, d as focusElement, g as getElementDir } from './dom-5badf0bf.js';
...
const CalciteMenu = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (h(Host, { key: '4ac65ed10e4e0ac2fb27ddfc3617f986d44a1a34' }, h("ul", { key: '341ba1488508497adf5428c7a4212a1fbcba72c5', "aria-label": this.label, role: this.getEffectiveRole() }, h("slot", { key: '9e6843d552fed1fcb88e21e5d0475a190d1a1048', onSlotchange: this.handleMenuSlotChange }))));
    }
