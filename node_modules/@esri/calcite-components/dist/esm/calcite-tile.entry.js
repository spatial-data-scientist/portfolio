...
import { b as slotChangeHasAssignedElement, t as toAriaBoolean } from './dom-5badf0bf.js';
import { c as componentFocusable, a as setComponentLoaded, s as setUpLoadableComponent } from './loadable-1c82fe7c.js';
...
const Tile = class {
    ...
    render() {
        const { disabled } = this;
        return (h(InteractiveContainer, { key: 'fefee534d623f2cb2c3d672ebe389fbf27bcd916', disabled: disabled }, this.href ? (h("calcite-link", { disabled: disabled, href: this.href }, this.renderTile())) : (this.renderTile())));
    }
