 ...
 * v2.10.1
 */
import { r as registerInstance, c as createEvent, h, f as forceUpdate, H as Host, g as getElement } from './index-c69832bf.js';
import { c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-326c9435.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-e3157659.js';
import { t as toAriaBoolean, b as slotChangeHasAssignedElement } from './dom-5badf0bf.js';
...
import { b as componentLoaded, s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-1c82fe7c.js';
...
const TextArea = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1cf8d8932cfc34863ec4f6954c05cab29be79e0a' }, h(InteractiveContainer, { key: '562df527b0a00e33a3f72c5dd1a5b921e4db48c4', disabled: this.disabled }, h("textarea", { key: '4044f82c8d7d86a83e2451350d7bb7d7f330485f', "aria-describedby": this.guid, "aria-invalid": toAriaBoolean(this.isCharacterLimitExceeded()), "aria-label": getLabelText(this), autofocus: this.el.autofocus, class: {
                [CSS.readOnly]: this.readOnly,
                [CSS.textAreaInvalid]: this.isCharacterLimitExceeded(),
                [CSS.footerSlotted]: this.endSlotHasElements && this.startSlotHasElements,
                [CSS.blockSizeFull]: !hasFooter,
                [CSS.borderColor]: !hasFooter,
            }, cols: this.columns, disabled: this.disabled, name: this.name, onChange: this.handleChange, onInput: this.handleInput, placeholder: this.placeholder, readOnly: this.readOnly, ref: this.setTextAreaEl, required: this.required, rows: this.rows, value: this.value, wrap: this.wrap }), h("span", { key: 'e23a55600d68239c78fc2fb98f289195f1d6a797', class: { [CSS.content]: true } }, h("slot", { key: '4ea0a5fe04210574843207e899d0ce16a1bb4c48', onSlotchange: this.contentSlotChangeHandler })), h("footer", { key: '07072a422762ca26f0f30b8497503edb8d77e8bc', class: {
                [CSS.footer]: true,
                [CSS.readOnly]: this.readOnly,
                [CSS.hide]: !hasFooter,
            }, ref: (el) => (this.footerEl = el) }, h("div", { key: '95c690b9ec35ebdd9ca008ac4213d49d57788e96', class: {
                [CSS.container]: true,
                [CSS.footerEndSlotOnly]: !this.startSlotHasElements && this.endSlotHasElements,
            } }, h("slot", { key: '65dbd9cef4d617c8bd9a6bbd610091f505188b0f', name: SLOTS.footerStart, onSlotchange: (event) => (this.startSlotHasElements = slotChangeHasAssignedElement(event)) }), h("slot", { key: '8e05f35c0c130fcde292c98f35b584dbc189f840', name: SLOTS.footerEnd, onSlotchange: (event) => (this.endSlotHasElements = slotChangeHasAssignedElement(event)) })), this.renderCharacterLimit()), h(HiddenFormInputSlot, { key: '7e0b7f5c82fab77065d8f8ce2d3f6dc877515602', component: this }), this.isCharacterLimitExceeded() && (h("span", { key: '4ed6485bc07b81aa5ce3e865c54fda74a054d691', "aria-hidden": true, "aria-live": "polite", class: CSS.assistiveText, id: this.guid }, this.replacePlaceHoldersInMessages())), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
