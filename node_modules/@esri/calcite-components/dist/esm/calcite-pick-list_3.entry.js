...
import { m as mutationObserverCallback, d as deselectRemovedItems, a as deselectSiblingItems, s as selectSiblings, h as handleFilter, b as handleFilterEvent, c as getItemData, k as keyDownHandler, i as initialize, f as initializeObserver, l as cleanUpObserver, j as handleInitialFilter, r as removeItem, o as calciteListItemChangeHandler, p as calciteInternalListItemValueChangeHandler, n as calciteListFocusOutHandler, q as setUpItems, t as setFocus, I as ICON_TYPES, L as List, u as SLOTS, v as CSS, w as ICONS, C as CSS$1, S as SLOTS$1 } from './resources-4874733e.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-fbd11a84.js';
import { e as getSlotted, t as toAriaBoolean } from './dom-5badf0bf.js';
import { H as Heading, c as constrainHeadingLevel } from './Heading-17eaa9a9.js';
...
const PickListGroup = class {
    ...
    render() {
        ...
        return (h(Fragment, { key: '6f435ddb455a5041cd5512e7571648eb0db1f36d' }, title ? (h(Heading, { class: CSS.heading, level: level }, title)) : null, h("slot", { key: 'aed7d2f298984c4d2f7b9d413375ab8b58bf78d3', name: SLOTS.parentItem }), h("section", { key: '7ce79b5559814aa3ff89b76f4b20f218234be84c', class: sectionClasses }, h("slot", { key: '7ded64937b644e7e53fdd59cf6cbf8144dc93d0d' }))));
    }
    get el() { return getElement(this); }
};
...
const PickListItem = class {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: 'b0a6a61daea92e2c4dc0ec2e31a6ad9c283e1727', disabled: this.disabled }, this.renderIcon(), this.renderActionsStart(), h("label", { key: 'eab25fdaee860109912439779800f89fc678f4f3', "aria-label": label, class: CSS$1.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, ref: (focusEl) => (this.focusEl = focusEl), tabIndex: 0 }, h("div", { key: 'e8e9ad80e3fab056e6c289d0e1a7c027be0625c8', "aria-checked": toAriaBoolean(this.selected), class: CSS$1.textContainer, role: "menuitemcheckbox" }, h("span", { key: '4523c6a57546d8e35284038c1988dba3838873be', class: CSS$1.title }, label), description ? h("span", { class: CSS$1.description }, description) : null)), this.renderActionsEnd()));
    }
