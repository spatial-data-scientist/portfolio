...
import { d as datePartsFromISO, a as datePartsFromLocalizedString, b as dateFromLocalizedString, i as inRange, c as dateToISO, g as getValueAsDateRange, e as dateFromISO, f as getLocaleData, h as dateFromRange } from './utils-a6b8b317.js';
import { f as focusFirstTabbable, t as toAriaBoolean } from './dom-5badf0bf.js';
import { f as filterValidFlipPlacements, c as connectFloatingUI, d as defaultMenuPlacement, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-bb27b135.js';
...
import { c as connectLabel, d as disconnectLabel } from './label-e3157659.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-1c82fe7c.js';
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized, b as getSupportedNumberingSystem } from './locale-2274ef15.js';
...
import { c as connectFocusTrap, d as deactivateFocusTrap, a as activateFocusTrap } from './focusTrapComponent-a4d396cc.js';
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'aa69d03a90a634fd434770a407971b0deb24782d', onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '5d30252fbcb3dab76b0cc0d81c90c3d75f75d520', disabled: this.disabled }, this.localeData && (h("div", { key: '846c8e4b6dcbf4c8452dd84dd8434989a0cd770e', class: CSS.inputContainer }, h("div", { key: '13625f578741424941b7b098f8e75693fd40d581', class: CSS.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setStartWrapper }, h("calcite-input-text", { key: '9e046258464c35d2d274376c130cff91363844e9', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-describedby": this.placeholderTextId, "aria-expanded": toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "start"), h("span", { key: '867993bfe3ba2602140e4401c97efb5480ca3ce5', "aria-hidden": "true", class: CSS.assistiveText, id: this.placeholderTextId }, "Date Format: ", this.localeData?.placeholder)), h("div", { key: '719763b40876f53da8018e22bcd9d87161f8c2fe', "aria-hidden": toAriaBoolean(!this.open), "aria-label": messages.chooseDate, "aria-live": "polite", "aria-modal": "true", class: {
                [CSS.menu]: true,
                [CSS.menuActive]: this.open,
            }, id: this.dialogId, ref: this.setFloatingEl, role: "dialog" }, h("div", { key: '981f7c95532de4f8dc742664a2c04370a522c164', class: {
                [CSS.calendarWrapper]: true,
                [CSS.calendarWrapperEnd]: this.focusedInput === "end",
                [FloatingCSS.animation]: true,
                [FloatingCSS.animationActive]: this.open,
            }, ref: this.setTransitionEl }, h("calcite-date-picker", { key: 'd40466e0fa7a8cca133444476f12a0d3e80b92d1', activeDate: this.datePickerActiveDate, activeRange: this.focusedInput, headingLevel: this.headingLevel, max: this.max, maxAsDate: this.maxAsDate, messageOverrides: this.messageOverrides, min: this.min, minAsDate: this.minAsDate, numberingSystem: numberingSystem, onCalciteDatePickerChange: this.handleDateChange, onCalciteDatePickerRangeChange: this.handleDateRangeChange, proximitySelectionDisabled: this.proximitySelectionDisabled, range: this.range, ref: this.setDatePickerRef, scale: this.scale, tabIndex: this.open ? undefined : -1, valueAsDate: this.valueAsDate }))), this.range && this.layout === "horizontal" && (h("div", { key: 'b41f729ce46f0a5578ff58e7507a1c6802fc6bfe', class: CSS.horizontalArrowContainer }, h("calcite-icon", { key: 'ea2aef7c844385fe99e81b7df1955bdc95f5926d', flipRtl: true, icon: "arrow-right", scale: getIconScale(this.scale) }))), this.range && this.layout === "vertical" && this.scale !== "s" && (h("div", { key: '743d7173f465a3c480ac43e41839338b205913a5', class: CSS.verticalArrowContainer }, h("calcite-icon", { key: '0e233a74f1df8560b3fd1c9b4e7889d37458ba2c', icon: "arrow-down", scale: getIconScale(this.scale) }))), this.range && (h("div", { key: '51a308d2835d37394a0b26bd7900533ef8dd948b', class: CSS.inputWrapper, "data-position": "end", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setEndWrapper }, h("calcite-input-text", { key: 'ef69ebe63fdc6068c5ba8ef469bf95780f81b841', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-expanded": toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "end"))))), h(HiddenFormInputSlot, { key: '22b9829585178610d9690130244000f579f556a7', component: this }), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
