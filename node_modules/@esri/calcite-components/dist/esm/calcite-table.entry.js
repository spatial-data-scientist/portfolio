...
import { s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-1c82fe7c.js';
...
import { g as getUserAgentString } from './browser-c7ad9bc1.js';
import './dom-5badf0bf.js';
...
const Table = class {
    ...
    render() {
        return (h(Host, { key: '303db103a86b0ac3593876f7c1365d151de38949' }, h("div", { key: '46ad58071827847e9771d5aa4f0687bb0d504cbd', class: CSS.container }, this.selectionMode !== "none" &&
            this.selectionDisplay !== "none" &&
            this.renderSelectionArea(), h("div", { key: 'ce6c9a94137aaf3116fe02e28e99f47c68f5874f', class: {
                [CSS.bordered]: this.bordered,
                [CSS.striped]: this.striped || this.zebra,
                [CSS.tableContainer]: true,
            } }, h("table", { key: '123286bcb3811bd6c4a71e5f8df15bb9a1ded395', "aria-colcount": this.colCount, "aria-multiselectable": this.selectionMode === "multiple", "aria-rowcount": this.allRows?.length, class: { [CSS.tableFixed]: this.layout === "fixed" }, role: this.interactionMode === "interactive" ? "grid" : "table" }, h("caption", { key: '6eda3a41c089f184b4f6c71f143ec4aaf18878a4', class: CSS.assistiveText }, this.caption), this.renderTHead(), this.renderTBody(), this.renderTFoot())), this.pageSize > 0 && this.renderPaginationArea())));
    }
