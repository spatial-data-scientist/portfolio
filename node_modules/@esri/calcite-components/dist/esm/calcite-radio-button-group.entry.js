...
const RadioButtonGroup = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (h(Host, { key: 'cfabfbb738ebfe1576fc216e0be953fe52df42da', role: "radiogroup" }, h("div", { key: '3660764c8e05b913242d7582fa6b4560adf458dc', class: CSS.itemWrapper }, h("slot", { key: '8a327ac7cce2e99e41239a5448d296ded5440479' })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
