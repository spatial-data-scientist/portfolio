 ...
 * v2.10.1
 */
import { r as registerInstance, c as createEvent, f as forceUpdate, h, H as Host, g as getElement } from './index-c69832bf.js';
import { e as getSlotted, l as isPrimaryPointerButton, h as setRequestedIcon, g as getElementDir } from './dom-5badf0bf.js';
import { s as submitForm, c as connectForm, i as internalHiddenInputInputEvent, d as disconnectForm, H as HiddenFormInputSlot } from './form-326c9435.js';
...
import { n as numberStringFormatter, i as isValidNumber, p as parseNumberString, s as sanitizeNumberString, a as addLocalizedTrailingDecimalZeros, c as connectLocalized, d as disconnectLocalized, B as BigDecimal } from './locale-2274ef15.js';
import { c as createObserver } from './observers-9479c046.js';
import { C as CSS_UTILITY } from './resources-fbc9037f.js';
import { u as updateMessages, c as connectMessages, d as disconnectMessages, s as setUpMessages } from './t9n-2ba79023.js';
...
const Input = class {
    ...
    render() {
        ...
        const loader = (h("div", { key: '91ca290797296d930565c4d5c8c1c5adcfadd42f', class: CSS.loader }, h("calcite-progress", { key: '2721ebc8dcf7fa5dfb17455f2e7bbfd925548856', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (h("button", { key: '9cdd4f14b0c4128281b12fd6156e8274b579968b', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, h("calcite-icon", { key: 'cb77c42adac45d939293624cda425fa8ff1fccdc', icon: "x", scale: getIconScale(this.scale) })));
        const iconEl = (h("calcite-icon", { key: '2e285859d4f3bfaaed8ffb284ba4595d88a05a0f', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (h("button", { key: '657b0297a616e827e7f9b4f6c216d216dd87e193', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '77a3bf36286924aafc9e3352e02acc578c3b5856', icon: "chevron-up", scale: getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (h("button", { key: '0deaf9efe2a4cb059ad24b8a2c8363ed1392726e', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { key: '13b751be5ad896baa26ccf6c234844b0d17abd06', icon: "chevron-down", scale: getIconScale(this.scale) })));
        const numberButtonsVertical = (h("div", { key: 'b738d15248ccf6cfe5447e1c34c9b1f65fc8a4e4', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = h("div", { key: 'e9b94004e6a6e0d4fafebc5a2e4d75f4d4b4e216', class: CSS.prefix }, this.prefixText);
        const suffixText = h("div", { key: '6cbe0d708f7a3a6deac4877b868f5bef28148c01', class: CSS.suffix }, this.suffixText);
        ...
        const childEl = this.type !== "number"
            ...
            : null;
        return (h(Host, { key: 'd64b5741e88f8a1f0fa7bf57b1fcd1c653ebb4e1', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: 'c2a88b41ad40cc71430241b92162c39b9e95e91f', disabled: this.disabled }, h("div", { key: '93a830ba649218eaa1d82e5fcb6e86e9c7f1125b', class: { [CSS.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, h("div", { key: '4c0265736053dbccd3d0bca070c3b00716c1753e', class: CSS.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { key: 'c3fee68974f3d04d6f843e30f598049861c9312a', class: CSS.actionWrapper }, h("slot", { key: '1ba027e1883626596fe1b06cb86fe3e6720c62b5', name: SLOTS.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly
            ? numberButtonsVertical
            : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, h(HiddenFormInputSlot, { key: '2770f59360cbc7cfacb854d8b6b9345c98fa7967', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
