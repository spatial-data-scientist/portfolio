 ...
 * v2.10.1
 */
import { r as registerInstance, h, H as Host } from './index-c69832bf.js';
import { b as slotChangeHasAssignedElement } from './dom-5badf0bf.js';
import { S as SLOTS, C as CSS } from './resources-57cef95c.js';
...
const Stack = class {
    ...
    render() {
        return (h(Host, { key: '492c80b97264841866409c59337d0cf189f4d818' }, h("div", { key: 'a5c669572afa0de9029c4eb8104c58e226e71e4b', class: CSS.container }, this.renderActionsStart(), this.renderContentStart(), this.renderDefaultContent(), this.renderContentEnd(), this.renderActionsEnd())));
    }
};
