 ...
 * v2.10.1
 */
import { r as registerInstance, f as forceUpdate, h, g as getElement, c as createEvent, H as Host } from './index-c69832bf.js';
import { g as guid } from './guid-13f267a8.js';
import { c as createObserver } from './observers-9479c046.js';
import { l as isPrimaryPointerButton, v as intersects } from './dom-5badf0bf.js';
import { c as connectForm, d as disconnectForm, a as afterConnectDefaultValueSet, H as HiddenFormInputSlot } from './form-326c9435.js';
...
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-2274ef15.js';
import { d as decimalPlaces, c as clamp } from './math-1c4eaaa4.js';
...
const Slider = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1e191b2451f079a5db30b7cc042943453c44f56a', id: id, onKeyDown: this.handleKeyDown, onTouchStart: this.handleTouchStart }, h(InteractiveContainer, { key: '140dd6f95d439e9bf8fd13d6c797fbbba8ae4d24', disabled: this.disabled }, h("div", { key: '2f6d8f2f6d32618db387dd01b1b3c21e93e619b2', "aria-label": getLabelText(this), class: {
                [CSS.container]: true,
                [CSS.containerRange]: valueIsRange,
                [`scale--${this.scale}`]: true,
            } }, this.renderGraph(), h("div", { key: 'd7bff8e4d6104f4db91a7f28f5945740216c27e9', class: CSS.track, ref: this.storeTrackRef }, h("div", { key: 'bc6095af9daf55093dc10afda224182d6170ee14', class: CSS.trackRange, onPointerDown: this.onTrackPointerDown, style: trackRangePlacementStyles }), h("div", { key: 'e814211cf1dba7b462d6c91e2fa2f62d48615599', class: CSS.ticks }, this.tickValues.map((tick) => {
        ...
        }))), h("div", { key: 'e4c936b67116dd415a9c6c950afba446fb025128', class: CSS.thumbContainer }, minThumb, thumb, h(HiddenFormInputSlot, { key: 'fa431ec11ffab1b639e1f4aeef31937661b27089', component: this }))))));
    }
