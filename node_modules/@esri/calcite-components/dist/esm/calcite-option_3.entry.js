 ...
 * v2.10.1
 */
import { r as registerInstance, c as createEvent, h, g as getElement, F as Fragment, H as Host } from './index-c69832bf.js';
import { c as createObserver } from './observers-9479c046.js';
import { d as focusElement } from './dom-5badf0bf.js';
...
const Option = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return h("slot", { key: '1fc4aa5b4af5d736dcf52c530167f225f465f195' }, this.label);
    }
...
const OptionGroup = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return (h(Fragment, { key: 'b4cd175214829ea1d1751ddae82e40559e477867' }, h("div", { key: '5342ad95ad2f3e7ba075bc5fb12e51b937f221af' }, this.label), h("slot", { key: '8cd0822a67680aec1dcebaba2b64a7c8389a1503' })));
    }
    static get watchers() { return {
        "disabled": ["handlePropChange"],
        "label": ["handlePropChange"]
...
const Select = class {
    ...
    render() {
        const { disabled } = this;
        return (h(Host, { key: '80f3cb1fef4ae35fe2b6e9deb524abf4d60f62aa' }, h(InteractiveContainer, { key: '293fc389614ae9921328f34dafc1849bd129c6a9', disabled: disabled }, h("div", { key: '09f5e5312cf8ba805fec4d7c1102981890834d09', class: CSS.wrapper }, h("select", { key: 'cc6a95b4dc105b3e4aeec499bf6007957e22a6ec', "aria-label": getLabelText(this), class: CSS.select, disabled: disabled, onChange: this.handleInternalSelectChange, ref: this.storeSelectRef }, h("slot", { key: 'f03975d523f1bd67cbe0ac0593a2fe2397f9d129' })), this.renderChevron(), h(HiddenFormInputSlot, { key: '4f89ff06734e30f384dc900aeec831b075de1df9', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "value": ["valueHandler"],
