 ...
 * v2.10.1
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, F as Fragment } from './index-c69832bf.js';
import { j as getDaysDiff, c as dateToISO, e as dateFromISO, g as getValueAsDateRange, h as dateFromRange, f as getLocaleData, s as setEndOfDay, k as sameDate, i as inRange, l as getOrder, n as nextMonth, p as prevMonth, m as formatCalendarYear, o as parseCalendarYear } from './utils-a6b8b317.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-1c82fe7c.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter, e as getDateTimeFormat } from './locale-2274ef15.js';
import { c as connectMessages, d as disconnectMessages, s as setUpMessages, u as updateMessages } from './t9n-2ba79023.js';
import { a as closestElementCrossShadowBoundary, t as toAriaBoolean } from './dom-5badf0bf.js';
import { I as InteractiveContainer, c as connectInteractive, u as updateHostInteraction, d as disconnectInteractive } from './interactive-81282a6f.js';
    ...
    render() {
        ...
        const maxDate = this.range && this.activeRange
            ? this.activeRange === "start"
                ...
                : this.maxAsDate
            : this.maxAsDate;
        return (h(Host, { key: 'd144e75cd7294401677080bd08b9765f083144fc', onBlur: this.resetActiveDates, onKeyDown: this.keyDownHandler }, this.renderCalendar(activeDate, maxDate, minDate, date, endDate)));
    }
