...
import { e as getSlotted, b as slotChangeHasAssignedElement, f as focusFirstTabbable, x as ensureId } from './dom-5badf0bf.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap, u as updateFocusTrapElements } from './focusTrapComponent-a4d396cc.js';
...
import { s as setUpMessages, c as connectMessages, d as disconnectMessages, u as updateMessages } from './t9n-2ba79023.js';
...
const Modal = class {
    ...
    render() {
        return (h(Host, { key: '5988d0ae6102227a53416a87e19623bcb6c2bff7', "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, h("div", { key: '7c38ff73a4925431bad86e09ba1594c16e01574a', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.slottedInShell]: this.slottedInShell,
            } }, h("calcite-scrim", { key: '0320fc0cb33f8a80c3a97da89e78060541f79ee1', class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), h("div", { key: '8dccbedf921a3cb9c2b70c3f184abd3362fed956', class: {
                [CSS.modal]: true,
            }, ref: this.setTransitionEl }, h("div", { key: '5eca173f4c4e8ba5e8b771195a3f8d3eb0a23481', class: CSS.header }, this.renderCloseButton(), h("header", { key: '8c5e8465066363660c39f7a9007b4371ee8b8b9b', class: CSS.title }, h("slot", { key: '69ad005c561f3382bb9dc6d7d62821c72e988df9', name: CSS.header }))), this.renderContentTop(), h("div", { key: '653ec9ea8e2a91bf7b1f2c5d24700050cc3b71d7', class: {
                [CSS.content]: true,
                [CSS.contentNoFooter]: !this.hasFooter,
            }, ref: (el) => (this.modalContent = el) }, h("slot", { key: 'cfb2ca243899891d2169eaf22db843171a90607a', name: SLOTS.content })), this.renderContentBottom(), this.renderFooter()))));
    }
    renderFooter() {
