...
import { s as slotChangeGetAssignedElements, k as focusElementInGroup, t as toAriaBoolean, g as getElementDir, B as whenAnimationDone } from './dom-5badf0bf.js';
...
import { g as getRoundRobinIndex } from './array-de591993.js';
...
const Carousel = class {
    ...
    render() {
        ...
        return (h(Host, { key: '7e95eee5f92be62d2817353deceb8ebceb330fb3' }, h(InteractiveContainer, { key: '01e449b425f695a3e1317190a7cb448ea4896e92', disabled: this.disabled }, h("div", { key: '1d59b22e5625facd195a57b8c9d8e64d855753a9', "aria-label": this.label, "aria-live": this.playing ? "off" : "polite", "aria-roledescription": this.messages.carousel, class: {
                [CSS$1.container]: true,
                [CSS$1.containerOverlaid]: this.controlOverlay,
                [CSS$1.containerEdged]: this.arrowType === "edge",
            }, onFocusin: this.handleFocusIn, onFocusout: this.handleFocusOut, onKeyDown: this.containerKeyDownHandler, onMouseEnter: this.handleMouseIn, onMouseLeave: this.handleMouseOut, ref: this.storeContainerRef, role: "group", tabIndex: 0 }, h("section", { key: '43ebcd93a10f25ca3a8c4cc9b2ff7f956293d35c', class: {
            ...
            ref: this.storeItemContainerRef }, h("slot", { key: '11c3d92e21496781f2bec4d5b45072c39cbc1280', onSlotchange: this.handleSlotChange })), this.items.length > 1 && this.renderPaginationArea(), this.arrowType === "edge" && this.renderArrow("previous"), this.arrowType === "edge" && this.renderArrow("next")))));
    }
