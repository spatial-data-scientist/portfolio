...
import { x as ensureId, g as getElementDir, f as focusFirstTabbable } from './dom-5badf0bf.js';
...
const Sheet = class {
    ...
    render() {
        ...
        return (h(Host, { key: '7a1ed7e069e9ee09b69dfe1280b383e26340c4fc', "aria-describedby": this.contentId, "aria-label": this.label, "aria-modal": "true", role: "dialog" }, h("div", { key: '67f710ed7e5fc3b6482f6cdf83872e069bd122f3', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.containerSlottedInShell]: this.slottedInShell,
                [CSS_UTILITY.rtl]: dir === "rtl",
            } }, h("calcite-scrim", { key: '157435029505414017c3584920097750e4a61e03', class: CSS.scrim, onClick: this.handleOutsideClose }), h("div", { key: '4f28851c36965f2556053356272ffe48586b6551', class: {
                [CSS.content]: true,
            }, ref: this.setTransitionEl }, h("slot", { key: '58a5bcb9a59a95033965dcbcf90785973d3d2738' })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
