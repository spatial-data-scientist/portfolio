...
const TileGroup = class {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: '7295e4d11cea10efc846dcbd44e29313f4e24ec1', disabled: this.disabled }, h("div", { key: 'a0f58d44165ed6fd430a9429a54f569acd366f5d', "aria-label": this.label, class: CSS.container, role: role }, h("slot", { key: '6826c4b01ada7d2e63324ce7cc9cc0ccaa8d9739', onSlotchange: this.updateTiles, ref: this.setSlotEl }))));
    }
