 ...
 * v2.10.1
 */
import { r as registerInstance, h, H as Host, g as getElement } from './index-c69832bf.js';
import { g as getElementDir, d as focusElement } from './dom-5badf0bf.js';
...
const Link = class {
    ...
    render() {
        ...
        const iconStartEl = (h("calcite-icon", { key: '456e22f692a8043bb209f400915fe1b08f54fec9', class: "calcite-link--icon icon-start", flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: "s" }));
        const iconEndEl = (h("calcite-icon", { key: 'a270787881023d34c3d9cd22a857400cb678a63a', class: "calcite-link--icon icon-end", flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: "s" }));
        const Tag = childElType;
        const role = childElType === "span" ? "link" : null;
        const tabIndex = childElType === "span" ? 0 : null;
        return (h(Host, { key: 'd69c67356efd44dc492510b3021eb345c4a40041', role: "presentation" }, h(InteractiveContainer, { key: '4bd9ac0dfcf77476e36257ba7eddb4088b8ed347', disabled: this.disabled }, h(Tag, { key: '39e243d41384cdc76ccaffa881a434c17c0380b9', class: { [CSS_UTILITY.rtl]: dir === "rtl" },
            /*
          When the 'download' property of type 'boolean | string' is set to true, the value is "".
          This works around that issue for now.
          */
            download: Tag === "a" && (download === "" || download) ? download : null, href: Tag === "a" && this.href, onClick: this.childElClickHandler, ref: this.storeTagRef, rel: Tag === "a" && this.rel, role: role, tabIndex: tabIndex, target: Tag === "a" && this.target }, this.iconStart ? iconStartEl : null, h("slot", { key: 'ab36d39e7d52fe70b48b23a29c32402f5da01843' }), this.iconEnd ? iconEndEl : null))));
    }
    //--------------------------------------------------------------------------
    //
    //  Events
