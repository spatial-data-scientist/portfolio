...
const Rating = class {
    ...
    render() {
        return (h(Host, { key: '1cdfcdebea3d3ed1ab27aecc103b80c3d9c6f8f2', onKeyDown: this.handleHostKeyDown, onPointerOut: this.handleRatingPointerOut, onPointerOver: this.handleRatingPointerOver }, h(InteractiveContainer, { key: '7967d681999450bf6d0a583dcc3b6eac892e6337', disabled: this.disabled }, h("span", { key: 'a4eede65a8bcba54970d208ad35f98c7f1c5f3e4', class: "wrapper" }, h("fieldset", { key: '65674e03084c4e8612168376965dda651f857d70', class: "fieldset", disabled: this.disabled }, h("legend", { key: '0d0ac44ef25a25f621ea58040e954c2ad7c0df8b', class: "visually-hidden" }, this.messages.rating), this.starsMap.map(({ average, checked, fraction, hovered, id, partial, selected, value, tabIndex, }) => {
        ...
        }), (this.count || this.average) && this.showChip ? (h("calcite-chip", { scale: this.scale, value: this.count?.toString() }, !!this.average && h("span", { class: "number--average" }, this.average.toString()), !!this.count && h("span", { class: "number--count" }, "(", this.count?.toString(), ")"))) : null), h(HiddenFormInputSlot, { key: 'cd5319562185a50f30aff46446c02de64710f46a', component: this })))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
