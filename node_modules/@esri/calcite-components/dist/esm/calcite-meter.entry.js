...
import { a as afterConnectDefaultValueSet, c as connectForm, d as disconnectForm } from './form-326c9435.js';
import { g as getSupportedLocale, n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-2274ef15.js';
import { v as intersects } from './dom-5badf0bf.js';
    ...
    render() {
        ...
        const valueText = valueLabelType === "percent"
            ...
            : unitLabel
                ? textUnitLabel
                : undefined;
        return (h(Host, { key: 'd4ce6f2e83c5211e8fb5f306fbfc0369e7d95608' }, h("div", { key: '09555ec77424d7f2d8c0c242aec246e8c7f6a1f1', "aria-label": label, "aria-valuemax": rangeLabelType === "percent" ? maxPercent : max, "aria-valuemin": rangeLabelType === "percent" ? minPercent : min, "aria-valuenow": valueLabelType === "percent" ? currentPercent : value, "aria-valuetext": valueText, class: {
                [CSS.container]: true,
