 ...
 * v2.10.1
 */
import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './index-c69832bf.js';
import { c as calciteSize48 } from './core-cc8d8866.js';
import { f as filter, e as escapeRegExp } from './filter-f41cc774.js';
import { C as nodeListToArray, E as getElementWidth, F as getTextWidth, t as toAriaBoolean, e as getSlotted } from './dom-5badf0bf.js';
import { d as defaultMenuPlacement, f as filterValidFlipPlacements, c as connectFloatingUI, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-bb27b135.js';
import { s as submitForm, c as connectForm, a as afterConnectDefaultValueSet, d as disconnectForm, H as HiddenFormInputSlot } from './form-326c9435.js';
...
import { b as componentLoaded, c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-1c82fe7c.js';
...
import { g as getIconScale, c as componentOnReady } from './component-f1a729cc.js';
import { V as Validation } from './Validation-04eac16d.js';
import { d as debounce } from './debounce-02487149.js';
...
function XButton({ disabled, key, label, onClick, ref, scale, }) {
    return (h("button", { "aria-label": label, class: CSS$3.button, disabled: disabled, key: key, onClick: onClick, ref: ref, tabIndex: -1, type: "button" },
