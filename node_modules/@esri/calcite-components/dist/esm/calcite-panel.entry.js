...
import { b as slotChangeHasAssignedElement, s as slotChangeGetAssignedElements, f as focusFirstTabbable, t as toAriaBoolean } from './dom-5badf0bf.js';
...
import { S as SLOTS$1 } from './resources-32e380fc.js';
...
import { S as SLOTS, C as CSS, I as ICONS } from './resources-71279f30.js';
...
const Panel = class {
    ...
    renderFooterNode() {
        ...
        return (h("footer", { class: CSS.footer, hidden: !showFooter }, h("slot", { name: SLOTS.footer, onSlotchange: this.handleFooterSlotChange }, h("slot", { name: SLOTS.footerStart, onSlotchange: this.handleFooterStartSlotChange }), h("slot", { name: SLOTS.footerEnd, onSlotchange: this.handleFooterEndSlotChange })), h("slot", { key: "footer-actions-slot", name: SLOTS.footerActions, onSlotchange: this.handleFooterActionsSlotChange })));
    }
    renderContent() {
    ...
    render() {
        ...
        const panelNode = (h("article", { key: 'a9ec3de60dbfa095ed5c18040738603975f35882', "aria-busy": toAriaBoolean(loading), class: CSS.container, hidden: closed, ref: this.setContainerRef, tabIndex: closable ? 0 : -1 }, this.renderHeaderNode(), this.renderContent(), this.renderContentBottom(), this.renderFooterNode()));
        return (h(Host, { key: 'd2dfb299ed634f2e67d3390c5d29386c6faa0373', onKeyDown: panelKeyDownHandler }, h(InteractiveContainer, { key: '2f139a9fcb0f57682e0e85ba1a6aec5b53a499d7', disabled: disabled }, loading ? h("calcite-scrim", { loading: loading }) : null, panelNode)));
    }
