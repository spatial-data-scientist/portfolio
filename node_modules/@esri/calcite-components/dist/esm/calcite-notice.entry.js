 ...
 * v2.10.1
 */
import { r as registerInstance, c as createEvent, h, g as getElement } from './index-c69832bf.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-fbd11a84.js';
import { h as setRequestedIcon, e as getSlotted } from './dom-5badf0bf.js';
...
import { c as connectMessages, d as disconnectMessages, s as setUpMessages, u as updateMessages } from './t9n-2ba79023.js';
import { K as KindIcons } from './resources-a2a031b1.js';
...
const Notice = class {
    ...
    render() {
        const { el } = this;
        const closeButton = (h("button", { key: '1b4ae79f5fc89f18c9d4d627083b4be8d8a92e3d', "aria-label": this.messages.close, class: CSS.close, onClick: this.close, ref: (el) => (this.closeButton = el) }, h("calcite-icon", { key: '1064f053c388a5c91050ac496c59c9bd9a5426ac', icon: "x", scale: getIconScale(this.scale) })));
        const hasActionEnd = getSlotted(el, SLOTS.actionsEnd);
        return (h("div", { key: '7ab86963e6d7e7a3de19cff902c2ecd63c0af24e', class: CSS.container, ref: this.setTransitionEl }, this.requestedIcon ? (h("div", { class: CSS.icon }, h("calcite-icon", { flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }))) : null, h("div", { key: '78c341c2e53c971418b4444b53a91f5aa1bb44a4', class: CSS.content }, h("slot", { key: '8abebe878544b8f114669416773ddbfa51a37667', name: SLOTS.title }), h("slot", { key: '527cff9ac8397c27a1da38771d8887ab489eb8c7', name: SLOTS.message }), h("slot", { key: '5c51f496846f890d554cd155de67c91f392fbf24', name: SLOTS.link })), hasActionEnd ? (h("div", { class: CSS.actionsEnd }, h("slot", { name: SLOTS.actionsEnd }))) : null, this.closable ? closeButton : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
