...
const SplitButton = class {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: '9816cd5d0599d1c5f8028fdc8ae73e131a3d5cde', disabled: this.disabled }, h("div", { key: '5da8524d892c4c9cc10e38597e83a5384d79069f', class: CSS.container }, h("calcite-button", { key: '78768e3ea566183d6050e57cdd33b9d7f0094628', appearance: this.appearance, disabled: this.disabled, "icon-end": this.primaryIconEnd ? this.primaryIconEnd : null, "icon-start": this.primaryIconStart ? this.primaryIconStart : null, iconFlipRtl: this.primaryIconFlipRtl ? this.primaryIconFlipRtl : null, kind: this.kind, label: this.primaryLabel, loading: this.loading, onClick: this.calciteSplitButtonPrimaryClickHandler, scale: this.scale, splitChild: "primary", type: "button", width: buttonWidth }, this.primaryText), h("div", { key: '0ba1be6e170e0ca37f137095408218e71c329f5f', class: CSS.dividerContainer }, h("div", { key: 'c74f972e11098664376b5d2111a0cb8c5c20bd18', class: CSS.divider })), h("calcite-dropdown", { key: 'cc63acc79dcbfa4d45de7de9cea7a45746a0f6c8', disabled: this.disabled, flipPlacements: this.flipPlacements, onClick: this.calciteSplitButtonSecondaryClickHandler, open: this.active, overlayPositioning: this.overlayPositioning, placement: this.placement, scale: this.scale, "width-scale": this.scale }, h("calcite-button", { key: 'c01f813baed84a23a47d1efc7002c4ca028a125d', appearance: this.appearance, disabled: this.disabled, "icon-start": this.dropdownIcon, kind: this.kind, label: this.dropdownLabel, scale: this.scale, slot: "trigger", splitChild: "secondary", type: "button" }), h("slot", { key: 'c8c326396544ed85f75e9b8a561dd16d3d84e39d' })))));
    }
    get dropdownIcon() {
