...
import { g as getElementDir, d as focusElement, t as toAriaBoolean } from './dom-5badf0bf.js';
...
const RadioButton = class {
    ...
    render() {
        ...
        return (h(Host, { key: '642f4817a74bd441bc64c14c1b955f806f768103', onClick: this.clickHandler, onKeyDown: this.handleKeyDown }, h(InteractiveContainer, { key: '84c69c965d8dabeb0d842fcac6def8540255daf6', disabled: this.disabled }, h("div", { key: '54e2ff13cb11854e594b80b5ac73230768347f85', "aria-checked": toAriaBoolean(this.checked), "aria-label": getLabelText(this), class: CSS.container, onBlur: this.onContainerBlur, onFocus: this.onContainerFocus, ref: this.setContainerEl, role: "radio", tabIndex: tabIndex }, h("div", { key: '6379e5099d9c9c51fe3579ebe01a6473f3ea8fa1', class: "radio" })), h(HiddenFormInputSlot, { key: '970dccd6968339fb67fcf5691fa39756c027ca9b', component: this }))));
    }
