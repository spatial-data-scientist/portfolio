...
import { d as focusElement, t as toAriaBoolean } from './dom-5badf0bf.js';
...
const Switch = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (h(Host, { key: '12bb296580214f4accddf5efd8ef6a7bd6d3768d', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '5f5627bf657f8dcb14360d4f7a0fa9adf7d4374e', disabled: this.disabled }, h("div", { key: 'f0b23182436727d14d18307bbc2532f08543f5ed', "aria-checked": toAriaBoolean(this.checked), "aria-label": getLabelText(this), class: CSS.container, ref: this.setSwitchEl, role: "switch", tabIndex: 0 }, h("div", { key: '8913eda6b5cc9d4cf4304283bf9699009ab6fe16', class: CSS.track }, h("div", { key: '8ade6efdaba228bde1b4c6cabe2910679d37d9bf', class: CSS.handle })), h(HiddenFormInputSlot, { key: 'ded92b55e79a980484b39cb9e89e475fa92b67cf', component: this })))));
    }
