...
import { e as getSlotted } from './dom-5badf0bf.js';
...
const InlineEditable = class {
    ...
    render() {
        return (h(InteractiveContainer, { key: '9d804b289b009024155d985a82cbca393acc3d99', disabled: this.disabled }, h("div", { key: 'b9cfaa90b5b8d805164ff3cd411ebd711bc697fa', class: CSS.wrapper, onClick: this.enableEditingHandler, onKeyDown: this.escapeKeyHandler }, h("div", { key: '04f0184aff5d1c69ccddb53d9772dc335ea8b94d', class: CSS.inputWrapper }, h("slot", { key: '2bd11ced5206f298130447ac4ae078eff6d78aa9' })), h("div", { key: '54ce37f7263519eefe47dd92cc7b5a5ce46b22bf', class: CSS.controlsWrapper }, h("calcite-button", { key: '3e587e9c886d0c59a790f2011b836d557a0d4f9b', appearance: "transparent", class: CSS.enableEditingButton, disabled: this.disabled, iconStart: "pencil", kind: "neutral", label: this.messages.enableEditing, onClick: this.enableEditingHandler, ref: (el) => (this.enableEditingButton = el), scale: this.scale, style: {
                opacity: this.editingEnabled ? "0" : "1",
                width: this.editingEnabled ? "0" : "inherit",
            }, type: "button" }), this.shouldShowControls && [
            h("div", { key: 'fe8561923218638a825642cb63cc917c5ea7dd24', class: CSS.cancelEditingButtonWrapper }, h("calcite-button", { key: '821b37b750bd5418a15701217d12debb4e79adbf', appearance: "transparent", class: CSS.cancelEditingButton, disabled: this.disabled, iconStart: "x", kind: "neutral", label: this.messages.cancelEditing, onClick: this.cancelEditingHandler, ref: (el) => (this.cancelEditingButton = el), scale: this.scale, type: "button" })),
            h("calcite-button", { key: '2a6dc4c239b7510397ec2d2a7d609a9d7747a49d', appearance: "solid", class: CSS.confirmChangesButton, disabled: this.disabled, iconStart: "check", kind: "brand", label: this.messages.confirmChanges, loading: this.loading, onClick: this.confirmChangesHandler, ref: (el) => (this.confirmEditingButton = el), scale: this.scale, type: "button" }),
        ]))));
    }
    //--------------------------------------------------------------------------
    //
