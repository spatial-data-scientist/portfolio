 ...
 * v2.10.1
 */
import { r as registerInstance, c as createEvent, h, g as getElement, F as Fragment } from './index-c69832bf.js';
import { C as CSSColorMode, n as normalizeHex, a as hexify, b as Color, o as opacityToAlpha, c as CSS$2, d as alphaToOpacity, D as DEFAULT_COLOR$1, e as DIMENSIONS, f as alphaCompatible, g as getSliderWidth, p as parseMode, j as normalizeColor, k as colorEqual, H as HSV_LIMITS, O as OPACITY_LIMITS, t as toNonAlphaMode, l as normalizeAlpha, m as HUE_LIMIT_CONSTRAINED, S as SCOPE_SIZE, q as DEFAULT_STORAGE_KEY_PREFIX, r as toAlphaMode, R as RGB_LIMITS, s as isLonghandHex, i as isValidHex, u as rgbToHex, v as hexChar } from './utils-3ae8ec1f.js';
import { l as isPrimaryPointerButton, g as getElementDir, d as focusElement, i as getModeName } from './dom-5badf0bf.js';
...
import { i as isActivationKey } from './key-3685937e.js';
...
import { r as remap, c as clamp, a as closeToRangeEdge } from './math-1c4eaaa4.js';
import { u as updateMessages, s as setUpMessages, c as connectMessages, d as disconnectMessages } from './t9n-2ba79023.js';
import { t as throttle } from './throttle-409d73aa.js';
...
const ColorPicker = class {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: 'ed8d6d887db9dc3d3e345b52b290094bde5541a8', disabled: this.disabled }, h("div", { key: '06f7fc8c31b3165de13f20219d7c138f162e059d', class: CSS$2.container }, h("div", { key: '79d751d245545fe729cb62660436ac67589a4be8', class: CSS$2.controlAndScope }, h("canvas", { key: '6fa2716d392b2f41f7c96e21d6e30c7738df4191', class: CSS$2.colorField, onPointerDown: this.handleColorFieldPointerDown, ref: this.initColorField }), h("div", { key: 'c51f4c15946f87bb71674c3aadd024cbd7514d55', "aria-label": vertical ? messages.value : messages.saturation, "aria-valuemax": vertical ? HSV_LIMITS.v : HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color?.saturationv() : color?.value()) || "0", class: { [CSS$2.scope]: true, [CSS$2.colorFieldScope]: true }, onKeyDown: this.handleColorFieldScopeKeyDown, ref: this.storeColorFieldScope, role: "slider", style: {
                top: `${adjustedColorFieldScopeTop || 0}px`,
                left: `${adjustedColorFieldScopeLeft || 0}px`,
            }, tabindex: "0" })), h("div", { key: '6f93b38c9b16234cd5bd68edbc6c44ed4351fab4', class: CSS$2.previewAndSliders }, h("calcite-color-picker-swatch", { key: 'dd12a18e453040e5af19c1e37ccbec3573cfd06b', class: CSS$2.preview, color: selectedColorInHex, scale: this.alphaChannel ? "l" : this.scale }), h("div", { key: 'cf3b9c928b0d43f912726d13b584afd90f028aa5', class: CSS$2.sliders }, h("div", { key: '77906dfdb66f64405ae2a62c942064d66eccf22d', class: CSS$2.controlAndScope }, h("canvas", { key: '1b8ed2fd600e16ddd34c3e3d97ee7c3c3fc21125', class: { [CSS$2.slider]: true, [CSS$2.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown, ref: this.initHueSlider }), h("div", { key: '73cb98a5adfd188433c434c0f832ac660f00966f', "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR$1.round().hue(), class: { [CSS$2.scope]: true, [CSS$2.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, ref: this.storeHueScope, role: "slider", style: {
...
const ColorPickerHexInput = class {
    ...
    render() {
        ...
        return (h("div", { key: '9939540e0bf570287d03276311c4d077e2ce1ae4', class: CSS$1.container }, h("calcite-input-text", { key: 'd2b6ab840fbd55bf16c6c5efe46d51e65b909cde', class: CSS$1.hexInput, label: messages?.hex || hexLabel, maxLength: 6, onCalciteInputTextChange: this.onHexInputChange, onCalciteInputTextInput: this.onHexInput, onCalciteInternalInputTextBlur: this.onHexInputBlur, onKeyDown: this.onInputKeyDown, onPaste: this.onHexInputPaste, prefixText: "#", ref: this.storeHexInputRef, scale: inputScale, value: hexInputValue }), alphaChannel ? (h("calcite-input-number", { class: CSS$1.opacityInput, key: "opacity-input", label: messages?.opacity, max: OPACITY_LIMITS.max, maxLength: 3, min: OPACITY_LIMITS.min, numberButtonType: "none", numberingSystem: this.numberingSystem, onCalciteInputNumberChange: this.onOpacityInputChange, onCalciteInternalInputNumberBlur: this.onOpacityInputBlur, onKeyDown: this.onInputKeyDown, ref: this.storeOpacityInputRef, scale: inputScale, suffixText: "%", value: opacityInputValue })) : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
