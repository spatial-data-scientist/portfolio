    ...
    render() {
        ...
        const role = this.selectionMode === "multiple"
            ...
            : this.selectionMode !== "none"
                ? "radio"
                : undefined;
        return (index.h(index.Host, { key: '4946d48f9a3a277437fd9b99346a3a3ef7f9dd9e' }, index.h(interactive.InteractiveContainer, { key: '3e6ca0e58bc05f655f2385e104bf34153e837a3b', disabled: this.disabled }, index.h("div", { key: '935420887e88fc36d7700fe9564f80d01b95fa6e', "aria-checked": this.selectionMode !== "none" ? dom.toAriaBoolean(this.selected) : undefined, "aria-disabled": this.disabled, "aria-label": this.label, class: { [CSS.contentWrapper]: true, inline: thumbnailInline }, onClick: this.cardBodyClickHandler, onKeyDown: this.keyDownHandler, ref: (el) => (this.containerEl = el), role: role, tabIndex: !this.selectable || this.disabled ? 0 : -1 }, this.loading ? (index.h("div", { "aria-live": "polite", class: "calcite-card-loader-container" }, index.h("calcite-loader", { label: this.messages.loading }))) : null, thumbnailStart && this.renderThumbnail(), index.h("section", { key: '42fc876326e43a398b7811d5c8a9d07b9e136d90', "aria-busy": dom.toAriaBoolean(this.loading), class: { [CSS.container]: true } }, this.renderHeader(), index.h("div", { key: '39c6dd91b34734469bbb91d9fe0f700a6b439dd3', class: {
                [CSS.cardContent]: true,
                [CSS.hasSlottedContent]: this.hasContent,
            } }, index.h("slot", { key: '8ee81529539d734e381c5359c675bd7cad60a553', onSlotchange: this.handleDefaultSlotChange })), this.renderFooter()), !thumbnailStart && this.renderThumbnail()))));
    }
