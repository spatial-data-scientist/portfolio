...
const Tile = class {
    ...
    render() {
        const { disabled } = this;
        return (index.h(interactive.InteractiveContainer, { key: 'fefee534d623f2cb2c3d672ebe389fbf27bcd916', disabled: disabled }, this.href ? (index.h("calcite-link", { disabled: disabled, href: this.href }, this.renderTile())) : (this.renderTile())));
    }
