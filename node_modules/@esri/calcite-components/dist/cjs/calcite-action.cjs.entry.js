...
const Action = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '65eaab1b65898e61d89af57f9d16048496eaf035' }, index.h(interactive.InteractiveContainer, { key: '6b412d3af4e4300d12024a8afec2e80d77d00c01', disabled: disabled }, index.h("button", { key: 'd6553a8c2fa4f4d81519bbfa1723e0992cc24092', "aria-busy": dom.toAriaBoolean(loading), "aria-controls": indicator ? indicatorId : null, "aria-disabled": dom.toAriaBoolean(disabled), "aria-label": ariaLabel, "aria-pressed": dom.toAriaBoolean(active), class: buttonClasses, disabled: disabled, id: buttonId, ref: (buttonEl) => (this.buttonEl = buttonEl) }, this.renderIconContainer(), this.renderTextContainer(), !icon && indicator && index.h("div", { class: CSS.indicatorWithoutIcon, key: "indicator-no-icon" })), index.h("slot", { key: '7b3ff5bf2884b655e5704ae0b68c0ff71c1177d1', name: SLOTS.tooltip, onSlotchange: this.handleTooltipSlotChange }), this.renderIndicatorText())));
    }
