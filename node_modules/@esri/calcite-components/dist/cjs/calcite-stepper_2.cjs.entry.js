...
const Stepper = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2be19afef4a5e085bfc4ea8f2f6cb65a6de83196', "aria-label": this.messages.label, role: "region" }, index.h("div", { key: 'e6bd09696b2dece88c200df2fcdf8b0ceadd5c8a', class: { container: true, [CSS$2.singleView]: this.layout === "horizontal-single" }, ref: this.setContainerEl }, this.layout === "horizontal-single" && (index.h("div", { key: 'd42d90048b6a473b84f6b9385dd096f5b4f68d55', class: { [CSS$2.stepBarContainer]: true } }, this.items.map((item, index$1) => (index.h(StepBar, { active: index$1 === this.currentActivePosition, complete: item.complete && index$1 !== this.currentActivePosition && !item.error, disabled: item.disabled && index$1 !== this.currentActivePosition, error: item.error && index$1 !== this.currentActivePosition, key: index$1 }))))), this.layout === "horizontal-single" && (index.h("div", { key: '86851a89f024c1da158d2fa49e1357b5710223e9', class: { [CSS$2.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), index.h("slot", { key: 'e635faa3273041dd35dcb4b737d2bdecf99ec639', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const StepperItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e558570c1e2068daec381888b4bb1e7826ec062c', "aria-current": this.selected ? "step" : "false", onClick: this.handleItemClick, onKeyDown: this.keyDownHandler, tabIndex: this.disabled ? -1 : 0 }, index.h(interactive.InteractiveContainer, { key: '67b2df92e4af3cfe2d6e449ee7860890d3adfb94', disabled: this.disabled }, index.h("div", { key: '6de1885c996ff0dfd2dbfbaa0671edfff4a23934', class: CSS.container }, this.complete && (index.h("span", { key: '275d720e03765bee32b2cd4427513a468bf83280', "aria-live": "polite", class: CSS.visuallyHidden }, this.messages.complete)), index.h("div", { key: 'ab6984c2b37de0bdf2a00be81456ddc325a1e010', class: CSS.stepperItemHeader, ref: (el) => (this.headerEl = el), tabIndex: 
            /* additional tab index logic needed because of display: contents */
            this.layout === "horizontal" && !this.disabled ? 0 : null }, this.icon ? this.renderIcon() : null, this.numbered ? (index.h("div", { class: CSS.stepperItemNumber }, this.renderNumbers(), ".")) : null, index.h("div", { key: '250e4875c4e755a1c2182595cb2b40cf12900808', class: CSS.stepperItemHeaderText }, index.h("span", { key: 'd1644434c42dcc1388dda9caf09afca01bded9a5', class: CSS.stepperItemHeading }, this.heading), index.h("span", { key: 'b1173d636da796ebc10af029e017100344f904df', class: CSS.stepperItemDescription }, this.description))), index.h("div", { key: '35fe242f95bcf185aa860a0b655feb188d664c16', class: CSS.stepperItemContent }, index.h("slot", { key: 'd374807564e5f3c5970624fa51639727cb004a44' }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
