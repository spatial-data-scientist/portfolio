...
const utils = require('./utils-cc34058a.js');
const dom = require('./dom-c234ded9.js');
const floatingUi = require('./floating-ui-1b0ae261.js');
...
const locale = require('./locale-f5df94e4.js');
...
require('./resources-8d1f7e23.js');
require('./debounce-38e2fe81.js');
require('./browser-0f2eda43.js');
require('./observers-719bb9c5.js');
require('./config-4960d556.js');
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aa69d03a90a634fd434770a407971b0deb24782d', onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: '5d30252fbcb3dab76b0cc0d81c90c3d75f75d520', disabled: this.disabled }, this.localeData && (index.h("div", { key: '846c8e4b6dcbf4c8452dd84dd8434989a0cd770e', class: CSS.inputContainer }, index.h("div", { key: '13625f578741424941b7b098f8e75693fd40d581', class: CSS.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setStartWrapper }, index.h("calcite-input-text", { key: '9e046258464c35d2d274376c130cff91363844e9', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-describedby": this.placeholderTextId, "aria-expanded": dom.toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "start"), index.h("span", { key: '867993bfe3ba2602140e4401c97efb5480ca3ce5', "aria-hidden": "true", class: CSS.assistiveText, id: this.placeholderTextId }, "Date Format: ", this.localeData?.placeholder)), index.h("div", { key: '719763b40876f53da8018e22bcd9d87161f8c2fe', "aria-hidden": dom.toAriaBoolean(!this.open), "aria-label": messages.chooseDate, "aria-live": "polite", "aria-modal": "true", class: {
                [CSS.menu]: true,
                [CSS.menuActive]: this.open,
            }, id: this.dialogId, ref: this.setFloatingEl, role: "dialog" }, index.h("div", { key: '981f7c95532de4f8dc742664a2c04370a522c164', class: {
            ...
            }, ref: this.setTransitionEl }, index.h("calcite-date-picker", { key: 'd40466e0fa7a8cca133444476f12a0d3e80b92d1', activeDate: this.datePickerActiveDate, activeRange: this.focusedInput, headingLevel: this.headingLevel, max: this.max, maxAsDate: this.maxAsDate, messageOverrides: this.messageOverrides, min: this.min, minAsDate: this.minAsDate, numberingSystem: numberingSystem, onCalciteDatePickerChange: this.handleDateChange, onCalciteDatePickerRangeChange: this.handleDateRangeChange, proximitySelectionDisabled: this.proximitySelectionDisabled, range: this.range, ref: this.setDatePickerRef, scale: this.scale, tabIndex: this.open ? undefined : -1, valueAsDate: this.valueAsDate }))), this.range && this.layout === "horizontal" && (index.h("div", { key: 'b41f729ce46f0a5578ff58e7507a1c6802fc6bfe', class: CSS.horizontalArrowContainer }, index.h("calcite-icon", { key: 'ea2aef7c844385fe99e81b7df1955bdc95f5926d', flipRtl: true, icon: "arrow-right", scale: component.getIconScale(this.scale) }))), this.range && this.layout === "vertical" && this.scale !== "s" && (index.h("div", { key: '743d7173f465a3c480ac43e41839338b205913a5', class: CSS.verticalArrowContainer }, index.h("calcite-icon", { key: '0e233a74f1df8560b3fd1c9b4e7889d37458ba2c', icon: "arrow-down", scale: component.getIconScale(this.scale) }))), this.range && (index.h("div", { key: '51a308d2835d37394a0b26bd7900533ef8dd948b', class: CSS.inputWrapper, "data-position": "end", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown, ref: this.setEndWrapper }, index.h("calcite-input-text", { key: 'ef69ebe63fdc6068c5ba8ef469bf95780f81b841', "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-expanded": dom.toAriaBoolean(this.open), "aria-haspopup": "dialog", class: {
                [CSS.input]: true,
            ...
            this.renderToggleIcon(this.open && this.focusedInput === "end"))))), index.h(form.HiddenFormInputSlot, { key: '22b9829585178610d9690130244000f579f556a7', component: this }), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
