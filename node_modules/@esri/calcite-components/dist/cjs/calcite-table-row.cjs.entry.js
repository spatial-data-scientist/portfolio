...
const TableRow = class {
    ...
    render() {
        return (index.h(index.Host, { key: '46546bb443b09dd88942b3af3871369d3da6c395' }, index.h(interactive.InteractiveContainer, { key: 'bda62c531c3623c20628c9302f1d166717bd5ef8', disabled: this.disabled }, index.h("tr", { key: '2420e0131b56feb56d9dc08c3a6b4e641bfd2875', "aria-disabled": this.disabled, "aria-rowindex": this.positionAll + 1, "aria-selected": this.selected, class: { [CSS.lastVisibleRow]: this.lastVisibleRow }, onKeyDown: this.keyDownHandler, ref: (el) => (this.tableRowEl = el) }, this.numbered && this.renderNumberedCell(), this.selectionMode !== "none" && this.renderSelectableCell(), index.h("slot", { key: 'f4ae062ff757091ca7ea00580261ea6b7abc9282', onSlotchange: this.updateCells, ref: (el) => (this.tableRowSlotEl = el) })))));
    }
