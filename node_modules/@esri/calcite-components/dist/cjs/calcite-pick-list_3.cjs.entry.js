...
const resources = require('./resources-a328effc.js');
...
const PickList = class {
    ...
    render() {
        return index.h(resources.List, { key: '9d1bd29bf2ced978448dce5615f7f8604aa04f54', onKeyDown: this.keyDownHandler, props: this });
    }
...
const PickListGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, { key: '6f435ddb455a5041cd5512e7571648eb0db1f36d' }, title ? (index.h(Heading.Heading, { class: resources.CSS$1.heading, level: level }, title)) : null, index.h("slot", { key: 'aed7d2f298984c4d2f7b9d413375ab8b58bf78d3', name: resources.SLOTS$1.parentItem }), index.h("section", { key: '7ce79b5559814aa3ff89b76f4b20f218234be84c', class: sectionClasses }, index.h("slot", { key: '7ded64937b644e7e53fdd59cf6cbf8144dc93d0d' }))));
    }
    get el() { return index.getElement(this); }
};
...
const PickListItem = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'b0a6a61daea92e2c4dc0ec2e31a6ad9c283e1727', disabled: this.disabled }, this.renderIcon(), this.renderActionsStart(), index.h("label", { key: 'eab25fdaee860109912439779800f89fc678f4f3', "aria-label": label, class: resources.CSS.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, ref: (focusEl) => (this.focusEl = focusEl), tabIndex: 0 }, index.h("div", { key: 'e8e9ad80e3fab056e6c289d0e1a7c027be0625c8', "aria-checked": dom.toAriaBoolean(this.selected), class: resources.CSS.textContainer, role: "menuitemcheckbox" }, index.h("span", { key: '4523c6a57546d8e35284038c1988dba3838873be', class: resources.CSS.title }, label), description ? index.h("span", { class: resources.CSS.description }, description) : null)), this.renderActionsEnd()));
    }
