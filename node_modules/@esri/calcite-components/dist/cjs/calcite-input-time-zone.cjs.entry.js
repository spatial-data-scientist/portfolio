    ...
    if (mode === "offset") {
        if (!timeZoneGroups) {
            timeZoneGroups = Promise.all([
                Promise.resolve().then(function () { return require('./index-428d6096.js'); }),
                Promise.resolve().then(function () { return require('./index-e1a61b71.js'); }),
            ]);
        }
...
const InputTimeZone = class {
    ...
    render() {
        ...
        })), index.h(form.HiddenFormInputSlot, { key: '55b39736821a60e2288e9c536189db7598302135', component: this }))));
    }
