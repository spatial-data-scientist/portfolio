...
const Tooltip = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'efe45cfea02c55dc9485e7f1760aef938aff1999', "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "tooltip" }, index.h("div", { key: '0110992190776206883f22752e73f2dc215890ed', class: {
                [floatingUi.FloatingCSS.animation]: true,
                [floatingUi.FloatingCSS.animationActive]: displayed,
            }, ref: this.setTransitionEl }, index.h(FloatingArrow.FloatingArrow, { key: '993f3df44f2104096966c5865217465868a028c3', floatingLayout: floatingLayout, ref: (arrowEl) => (this.arrowEl = arrowEl) }), index.h("div", { key: '3289d59eba5264aa5bff0285441452861ac49d8b', class: CSS.container }, index.h("slot", { key: 'e060c878105353e47ecb5dfc9b85888be791c8c9' })))));
    }
