...
const TileSelect = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: '7acdfde84246014561a51fe868208c315cf5a3ed', disabled: disabled }, index.h("div", { key: 'c8c672449fc79db97fd13b6198eea4da627f75f2', class: {
                checked,
                container: true,
            ...
            } }, index.h("div", { key: '40a366c01297f703d656b6452132b675a4023ece', class: { [CSS.tile]: true, [CSS.tileLargeVisual]: isLargeVisual } }, icon && (index.h("div", { key: '82310a812aac47ec904091e6284b55519d5ee242', class: { [CSS.icon]: renderIcon } }, index.h("calcite-icon", { key: '506fa463a99ae0eafee798ac6944408db8ded8f0', flipRtl: iconFlipRtl, icon: icon, scale: "l" }))), index.h("div", { key: 'bca3d226f4aa3aadb58c38851d15dbc424383ff9', class: CSS.tileContentContainer }, index.h("div", { key: 'eb256a4f0cd1ba213a562de5b7da58bb11b28e48', class: CSS.tileContent }, heading && index.h("div", { key: '228f8472a5ed9e00e3b8b34f8b3459147e173145', class: CSS.tileHeading }, heading), description && index.h("div", { key: '173e5e4efe4076d5beec291e88167ddd83d4f376', class: CSS.tileDescription }, description)))), index.h("slot", { key: 'f9fa7eecad83c321c9ab2f2401149777fa8dd222' }))));
    }
...
const TileSelectGroup = class {
    ...
    render() {
        return (index.h(interactive.InteractiveContainer, { key: 'c2b3ea84b52caa807e718d047df4544496145dc6', disabled: this.disabled }, index.h("slot", { key: 'aad045941f8c7ea5f1c335b37d7a9dcb7ccd4a3f' })));
    }
    get el() { return index.getElement(this); }
};
