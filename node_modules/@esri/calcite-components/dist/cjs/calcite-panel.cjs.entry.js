...
const Panel = class {
    ...
    renderFooterNode() {
        ...
        return (index.h("footer", { class: resources.CSS.footer, hidden: !showFooter }, index.h("slot", { name: resources.SLOTS.footer, onSlotchange: this.handleFooterSlotChange }, index.h("slot", { name: resources.SLOTS.footerStart, onSlotchange: this.handleFooterStartSlotChange }), index.h("slot", { name: resources.SLOTS.footerEnd, onSlotchange: this.handleFooterEndSlotChange })), index.h("slot", { key: "footer-actions-slot", name: resources.SLOTS.footerActions, onSlotchange: this.handleFooterActionsSlotChange })));
    }
    renderContent() {
    ...
    render() {
        ...
        const panelNode = (index.h("article", { key: 'a9ec3de60dbfa095ed5c18040738603975f35882', "aria-busy": dom.toAriaBoolean(loading), class: resources.CSS.container, hidden: closed, ref: this.setContainerRef, tabIndex: closable ? 0 : -1 }, this.renderHeaderNode(), this.renderContent(), this.renderContentBottom(), this.renderFooterNode()));
        return (index.h(index.Host, { key: 'd2dfb299ed634f2e67d3390c5d29386c6faa0373', onKeyDown: panelKeyDownHandler }, index.h(interactive.InteractiveContainer, { key: '2f139a9fcb0f57682e0e85ba1a6aec5b53a499d7', disabled: disabled }, loading ? index.h("calcite-scrim", { loading: loading }) : null, panelNode)));
    }
