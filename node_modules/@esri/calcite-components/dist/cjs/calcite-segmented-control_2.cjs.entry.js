...
const SegmentedControl = class {
    ...
    render() {
        return (index.h(index.Host, { key: '86fd4fde810b6857124af636da329a5fcf8b6864', onClick: this.handleClick, role: "radiogroup" }, index.h("div", { key: '1e42ccc9a60a1182ed00a7a9199e002150b11aed', class: CSS$1.itemWrapper }, index.h(interactive.InteractiveContainer, { key: '155638d65fea182e911f4cd2136a88a428bfbf08', disabled: this.disabled }, index.h("slot", { key: 'fc90d4dc13a6d7211d42c74d741ac7dd92d5201d' }), index.h(form.HiddenFormInputSlot, { key: '59b0c94ab67d540184ceb4f52dd11a594336f9a0', component: this }))), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
...
const SegmentedControlItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'acba894d3206d103930f8c76c6a910168979a210', "aria-checked": dom.toAriaBoolean(checked), "aria-label": value, role: "radio" }, index.h("label", { key: '8553c78d40c3ad4cd321a099a7ae1266d794dbf0', class: {
                [CSS.label]: true,
