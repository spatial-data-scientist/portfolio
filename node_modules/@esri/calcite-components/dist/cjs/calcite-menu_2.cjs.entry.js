...
const CalciteMenu = class {
    ...
    // --------------------------------------------------------------------------
    render() {
        return (index.h(index.Host, { key: '4ac65ed10e4e0ac2fb27ddfc3617f986d44a1a34' }, index.h("ul", { key: '341ba1488508497adf5428c7a4212a1fbcba72c5', "aria-label": this.label, role: this.getEffectiveRole() }, index.h("slot", { key: '9e6843d552fed1fcb88e21e5d0475a190d1a1048', onSlotchange: this.handleMenuSlotChange }))));
    }
