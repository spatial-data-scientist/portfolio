...
const Slider = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1e191b2451f079a5db30b7cc042943453c44f56a', id: id, onKeyDown: this.handleKeyDown, onTouchStart: this.handleTouchStart }, index.h(interactive.InteractiveContainer, { key: '140dd6f95d439e9bf8fd13d6c797fbbba8ae4d24', disabled: this.disabled }, index.h("div", { key: '2f6d8f2f6d32618db387dd01b1b3c21e93e619b2', "aria-label": label.getLabelText(this), class: {
                [CSS.container]: true,
                [CSS.containerRange]: valueIsRange,
                [`scale--${this.scale}`]: true,
            } }, this.renderGraph(), index.h("div", { key: 'd7bff8e4d6104f4db91a7f28f5945740216c27e9', class: CSS.track, ref: this.storeTrackRef }, index.h("div", { key: 'bc6095af9daf55093dc10afda224182d6170ee14', class: CSS.trackRange, onPointerDown: this.onTrackPointerDown, style: trackRangePlacementStyles }), index.h("div", { key: 'e814211cf1dba7b462d6c91e2fa2f62d48615599', class: CSS.ticks }, this.tickValues.map((tick) => {
        ...
        }))), index.h("div", { key: 'e4c936b67116dd415a9c6c950afba446fb025128', class: CSS.thumbContainer }, minThumb, thumb, index.h(form.HiddenFormInputSlot, { key: 'fa431ec11ffab1b639e1f4aeef31937661b27089', component: this }))))));
    }
