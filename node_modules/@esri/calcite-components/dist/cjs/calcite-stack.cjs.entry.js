...
const Stack = class {
    ...
    render() {
        return (index.h(index.Host, { key: '492c80b97264841866409c59337d0cf189f4d818' }, index.h("div", { key: 'a5c669572afa0de9029c4eb8104c58e226e71e4b', class: resources.CSS.container }, this.renderActionsStart(), this.renderContentStart(), this.renderDefaultContent(), this.renderContentEnd(), this.renderActionsEnd())));
    }
};
