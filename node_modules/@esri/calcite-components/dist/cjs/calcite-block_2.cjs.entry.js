...
const Heading = require('./Heading-93d7fa44.js');
...
const Block = class {
    ...
    render() {
        ...
        const headerContent = (index.h("header", { key: '09de168983611cb923294443ec7a89942133e767', class: CSS$1.header, id: IDS$1.header }, this.renderIcon("start"), this.renderContentStart(), this.renderLoaderStatusIcon(), this.renderTitle()));
        ...
        const headerNode = (index.h("div", { key: '2c03c73685db7feb04844be8f0b308add3eb2aa6', class: CSS$1.headerContainer }, this.dragHandle ? index.h("calcite-handle", { label: heading }) : null, collapsible ? (index.h("button", { "aria-controls": IDS$1.content, "aria-describedby": IDS$1.header, "aria-expanded": collapsible ? dom.toAriaBoolean(open) : null, class: CSS$1.toggle, id: IDS$1.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, index.h("div", { class: CSS$1.iconEndContainer }, this.renderIcon("end"), index.h("calcite-icon", { class: CSS$1.toggleIcon, icon: collapseIcon, scale: "s" })))) : this.iconEnd ? (index.h("div", null, headerContent, index.h("div", { class: CSS$1.iconEndContainer }, this.renderIcon("end")))) : (headerContent), hasControl ? (index.h("div", { "aria-labelledby": IDS$1.header, class: CSS$1.controlContainer }, index.h("slot", { name: SLOTS.control }))) : null, hasMenuActions ? (index.h("calcite-action-menu", { label: messages.options, overlayPositioning: this.overlayPositioning }, index.h("slot", { name: SLOTS.headerMenuActions }))) : null, this.renderActionsEnd()));
        return (index.h(index.Host, { key: 'e33a4f97740d5e0f6d41d5014546925c3637c40b' }, index.h(interactive.InteractiveContainer, { key: '88b24fc8283f230feccc910b9925fc9d6a23ae55', disabled: this.disabled }, index.h("article", { key: '81e09b5a468cffcd68414ad518b69bd2ef56189c', "aria-busy": dom.toAriaBoolean(loading), class: {
                [CSS$1.container]: true,
            } }, headerNode, index.h("section", { key: '44d82173efbdbeec15dbf3f7a9ec191bc2d17a11', "aria-labelledby": IDS$1.toggle, class: CSS$1.content, hidden: !open, id: IDS$1.content, ref: this.setTransitionEl }, this.renderScrim())))));
    }
...
const BlockSection = class {
    ...
    renderIcon(icon) {
        ...
        /** Icon scale is not variable as the component does not have a scale property */
        return (index.h("calcite-icon", { class: isIconStart ? this.iconStart : this.iconEnd, flipRtl: isIconStart ? flipRtlStart : flipRtlEnd, icon: isIconStart ? this.iconStart : this.iconEnd, key: isIconStart ? CSS.iconStart : CSS.iconEnd, scale: "s" }));
    }
    render() {
        ...
        return (index.h(index.Host, { key: 'cb073bc654bdb57aa9f315017c1fd34f010aeb3c' }, headerNode, index.h("section", { key: 'c03ccc99f8a6c1bf19ba9b1d38e0fce5a62dd0f5', "aria-labelledby": IDS.toggle, class: CSS.content, hidden: !open, id: IDS.content }, index.h("slot", { key: 'c7704b42a05a4f673c9008a71504bdf2a8b6b4da' }))));
    }
    static get assetsDirs() { return ["assets"]; }
    get el() { return index.getElement(this); }
    static get watchers() { return {
