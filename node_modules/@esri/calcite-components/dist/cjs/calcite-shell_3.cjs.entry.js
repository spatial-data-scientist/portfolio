...
const Shell = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'd5ca9178c4e9c74dae958a6105655a5d30de1584' }, this.renderHeader(), this.renderMain(), this.renderFooter(), this.renderPositionedSlots()));
    }
...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (index.h("div", { key: '272dced8d569d7cbb822739dea81fc4e66e773f6', class: CSS$1.content }, index.h("slot", { key: '7eb60d427747c4c05a9c4c64465f8ee0519cf9c2' })));
        ...
        return index.h(index.Fragment, { key: 'eba71689b26127da5043ab43bbd746702e59b788' }, children);
    }
    get el() { return index.getElement(this); }
};
