...
const Tree = class {
    ...
    render() {
        return (index.h(index.Host, { key: '60482915d0c0020ff558e562fccbb9cba064b1b2', "aria-multiselectable": this.child
                ? undefined
                : (this.selectionMode === "multiple" || this.selectionMode === "multichildren").toString(), onKeyDown: this.keyDownHandler, role: !this.child ? "tree" : undefined, tabIndex: this.getRootTabIndex() }, index.h("slot", { key: 'f9d50bf3c4c0e75be2c0f9cc9676aa7b7e703e0d' })));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const TreeItem = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: 'fa6de7e7de920a005ae48378d32cc85763e6e164', class: CSS.iconStart, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        return (index.h(index.Host, { key: '4ab7794c9d33e6102dc4de5133aa297b1a55a9b0', "aria-expanded": this.hasChildren ? dom.toAriaBoolean(isExpanded) : undefined, "aria-hidden": dom.toAriaBoolean(hidden), "aria-selected": this.selected ? "true" : showCheckmark ? "false" : undefined, "calcite-hydrated-hidden": hidden, role: "treeitem", tabIndex: this.disabled ? -1 : 0 }, index.h(interactive.InteractiveContainer, { key: '88199a3a8f3b0f24ccf8b0da090d99d26a398eb4', disabled: this.disabled }, index.h("div", { key: 'f8e349927173e3de2ed7a3bb908c1de36dc9c176', class: { [CSS.itemExpanded]: isExpanded } }, index.h("div", { key: '334b187995b0c273b7c9ac979562c10384060f31', class: CSS.nodeAndActionsContainer }, index.h("div", { key: '5cf871f0a46784b28309e2832c953af130001225', class: {
                [CSS.nodeContainer]: true,
                [resources.CSS_UTILITY.rtl]: rtl,
            }, "data-selection-mode": this.selectionMode, ref: (el) => (this.defaultSlotWrapper = el) }, chevron, itemIndicator, this.iconStart ? iconStartEl : null, checkbox ? checkbox : defaultSlotNode), index.h("div", { key: '3bf93ad9e883bc5f29877a874de754e18b7451fc', class: CSS.actionsEnd, hidden: !hasEndActions, ref: (el) => (this.actionSlotWrapper = el) }, slotNode)), index.h("div", { key: 'fe64fb095521af5336728a486a86721a2ab8416e', class: {
                [CSS.childrenContainer]: true,
                [resources.CSS_UTILITY.rtl]: rtl,
            }, "data-test-id": "calcite-tree-children", onClick: this.childrenClickHandler, role: this.hasChildren ? "group" : undefined }, index.h("slot", { key: '9a6ccbac1cfc2ea1e19ef09739b81aa732bf2b58', name: SLOTS.children }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
