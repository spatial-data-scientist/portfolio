...
const ValueList = class {
    ...
    render() {
        return (index.h(resources.List, { key: '7b7e6672040336078e883b0e7495cacc45d29344', onBlur: this.handleBlur, onFocusin: this.handleFocusIn, onKeyDown: this.keyDownHandler, props: this }));
    }
...
const ValueListItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd89ea77d31ede37aebb655ee1ab7e667df1b76b9', id: this.el.id || this.guid }, index.h(interactive.InteractiveContainer, { key: 'aa4bec39005964d0aad6b58ffc74ee34218cf58c', disabled: this.disabled }, this.renderHandle(), index.h("calcite-pick-list-item", { key: 'b3788f4ac44bec53f5b7d09a5fccc9fb0db39f49', description: this.description, deselectDisabled: this.deselectDisabled, disabled: this.disabled, label: this.label, metadata: this.metadata, nonInteractive: this.nonInteractive, onCalciteListItemChange: this.handleSelectChange, ref: this.getPickListRef, removable: this.removable, selected: this.selected, value: this.value }, this.renderActionsStart(), this.renderActionsEnd()))));
    }
    get el() { return index.getElement(this); }
};
