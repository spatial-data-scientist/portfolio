...
const core = require('./core-778cf1ac.js');
...
const Tab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '34f25633afec73b771fba5a8d2c35e647dbc7abe', "aria-labelledby": this.labeledBy, id: id }, index.h("div", { key: '8ee7f4025cc393cfb3f4d53a6762a50017abbfe8', class: { [CSS$2.container]: true, [`scale-${this.scale}`]: true }, role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, index.h("section", { key: 'eda53c19a48f0a96b52362a588292139f8526da4', class: CSS$2.content }, index.h("slot", { key: 'c1da92b857f33df134cbaf5eeddc3f8fcda1f5dc' })))));
    }
    connectedCallback() {
...
const TabNav = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '174cd3c34b59be8c237cb1bd2e143d8d9369198c', role: "tablist" }, index.h("div", { key: '3431edaba38c8875d6077a649610d2f21173df47', class: {
            ...
            }, ref: this.storeContainerRef }, this.renderScrollButton("start"), index.h("div", { key: '1fee2edb04f475641523b66d5fbe4e62a7403c26', class: {
                [CSS$1.tabTitleSlotWrapper]: true,
            }, onScroll: this.onTabTitleScroll, onWheel: this.onTabTitleWheel, ref: this.storeTabTitleWrapperRef }, index.h("slot", { key: 'e14eea620096ffa9bc6d518ce31ebe0f623bdf4e', onSlotchange: this.onSlotChange })), index.h("div", { key: '1ec5cff7490ac9ae87b0dab467ca3890c217a3b3', class: {
                [CSS$1.activeIndicatorContainer]: true,
            }, ref: (el) => (this.activeIndicatorContainerEl = el) }, index.h("div", { key: 'e0e10bbeedcae6bcf1f5d5957d35e06e555fd14c', class: "tab-nav-active-indicator", ref: (el) => (this.activeIndicatorEl = el), style: indicatorStyle })), this.renderScrollButton("end"))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const TabTitle = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { key: 'c6c7baa28fe5aa5ed07d85815d0a0ebac4318368', class: { [CSS.titleIcon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: component.getIconScale(this.scale) }));
        const iconEndEl = (index.h("calcite-icon", { key: 'fc5e9d925510867e451df60bed298b158a10054b', class: { [CSS.titleIcon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: component.getIconScale(this.scale) }));
        return (index.h(index.Host, { key: 'd84446a2e6fb8a9007c70a798e997d2f8bae485e', "aria-controls": this.controls, "aria-selected": dom.toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected && !this.disabled ? 0 : -1 }, index.h(interactive.InteractiveContainer, { key: '0130123cde98ed0f0e5065387156293fda2d1c4b', disabled: this.disabled }, index.h("div", { key: 'c37a2e097b38dd17588a7eb81fa4fa2c5f3977a9', class: {
                container: true,
                [CSS.iconPresent]: !!this.iconStart || !!this.iconEnd,
                [`scale-${this.scale}`]: true,
            }, hidden: closed, ref: (el) => this.resizeObserver?.observe(el) }, index.h("div", { key: '53065b8558e4e0732aaeb60624367547a0aee7f8', class: { [CSS.content]: true, [CSS.contentHasText]: this.hasText } }, this.iconStart ? iconStartEl : null, index.h("slot", { key: 'c05fdb2126495f59fe88e32b5368e8ad8a79b303' }), this.iconEnd ? iconEndEl : null), this.renderCloseButton()))));
    }
    renderCloseButton() {
...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '8f47fe2cdeb7897a888891ba33b3fcda0d1d2b10' }, index.h("slot", { key: 'e19648c5138807be98e46ff6a343989a8d931c86', name: SLOTS.titleGroup }), index.h("section", { key: '64880a376a2cda485d608ba00fe3431fdb7ea011' }, index.h("slot", { key: '2cbd9deb8203448212357a4de42f5ac4a1f5daad' }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
