...
const browser = require('./browser-0f2eda43.js');
require('./dom-c234ded9.js');
...
const Table = class {
    ...
    render() {
        return (index.h(index.Host, { key: '303db103a86b0ac3593876f7c1365d151de38949' }, index.h("div", { key: '46ad58071827847e9771d5aa4f0687bb0d504cbd', class: CSS.container }, this.selectionMode !== "none" &&
            this.selectionDisplay !== "none" &&
            this.renderSelectionArea(), index.h("div", { key: 'ce6c9a94137aaf3116fe02e28e99f47c68f5874f', class: {
                [CSS.bordered]: this.bordered,
                [CSS.striped]: this.striped || this.zebra,
                [CSS.tableContainer]: true,
            } }, index.h("table", { key: '123286bcb3811bd6c4a71e5f8df15bb9a1ded395', "aria-colcount": this.colCount, "aria-multiselectable": this.selectionMode === "multiple", "aria-rowcount": this.allRows?.length, class: { [CSS.tableFixed]: this.layout === "fixed" }, role: this.interactionMode === "interactive" ? "grid" : "table" }, index.h("caption", { key: '6eda3a41c089f184b4f6c71f143ec4aaf18878a4', class: CSS.assistiveText }, this.caption), this.renderTHead(), this.renderTBody(), this.renderTFoot())), this.pageSize > 0 && this.renderPaginationArea())));
    }
