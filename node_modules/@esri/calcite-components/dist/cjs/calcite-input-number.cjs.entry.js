...
const InputNumber = class {
    ...
    render() {
        ...
        const loader = (index.h("div", { key: '792a159864fecad5a3f8f8a12f99da26bf7d978b', class: CSS.loader }, index.h("calcite-progress", { key: '0be46f7aeed43519c2f12c8991257e94151035f3', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (index.h("button", { key: '4b5cd4a3b1dcfc52ec2e543a4c72a4407f1a7428', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: 'd89fa3a009124fe451f5a82e913f89d80ebd3b9a', icon: "x", scale: component.getIconScale(this.scale) })));
        const iconEl = (index.h("calcite-icon", { key: 'ddde33f2e405f17561a000cdc48c3736a4117ac3', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: component.getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (index.h("button", { key: '0fd04a0153c74c1fc81892dd4dbe5a31f67f4eb9', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerOutHandler, onPointerUp: this.nudgeButtonPointerUpHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '2b12b651f53d4a519518efe84e5bc84f97f9dbe1', icon: "chevron-up", scale: component.getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (index.h("button", { key: 'cb046f61566d5bd316c60aed147877b7bb3cf634', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerOutHandler, onPointerUp: this.nudgeButtonPointerUpHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '65930ea168d80198101844d692dbcfbb639dd97a', icon: "chevron-down", scale: component.getIconScale(this.scale) })));
        const numberButtonsVertical = (index.h("div", { key: '57f22f634162c4e3c377c54cd65b42d71f4ad266', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = index.h("div", { key: '7af4c5da294fb0d8e275ce440a98ed9f51326657', class: CSS.prefix }, this.prefixText);
        const suffixText = index.h("div", { key: 'ef579965ea46806676af208a2ee31e5e69c9be89', class: CSS.suffix }, this.suffixText);
        ...
        return (index.h(index.Host, { key: '81ff4a340635b293add9a060e5c7ea3891e36701', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: 'f14b00b8b0e94e81714adc7059f47e07fa7c8867', disabled: this.disabled }, index.h("div", { key: '06c06fa7b1f19090152dedf758ef808509b29e6b', class: { [CSS.inputWrapper]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" } }, this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, index.h("div", { key: 'a9e3fe40c6ae6f6917b76645ab53fd93c14ce6de', class: CSS.wrapper }, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), index.h("div", { key: '99b7ed45a27506f9fd8ae635c1817eb328c579ff', class: CSS.actionWrapper }, index.h("slot", { key: 'd1d9025fd4de24400ee2c708e9bfad747e5afaed', name: SLOTS.action })), this.numberButtonType === "vertical" && !this.readOnly ? numberButtonsVertical : null, this.suffixText ? suffixText : null, this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, index.h(form.HiddenFormInputSlot, { key: '5e981eb0204b50b3262f7b6cce7162ff4729e08e', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
