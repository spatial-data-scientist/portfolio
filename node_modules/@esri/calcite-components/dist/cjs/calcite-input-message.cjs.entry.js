...
const InputMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd25eda9bcff16d0d71d1373e87b27fd39df842f1', "calcite-hydrated-hidden": hidden }, this.renderIcon(this.requestedIcon), index.h("slot", { key: 'aa5c6414007081f521e9354118aeb1365aa04c88' })));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
