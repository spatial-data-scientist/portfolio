...
const Option = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return index.h("slot", { key: '1fc4aa5b4af5d736dcf52c530167f225f465f195' }, this.label);
    }
...
const OptionGroup = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return (index.h(index.Fragment, { key: 'b4cd175214829ea1d1751ddae82e40559e477867' }, index.h("div", { key: '5342ad95ad2f3e7ba075bc5fb12e51b937f221af' }, this.label), index.h("slot", { key: '8cd0822a67680aec1dcebaba2b64a7c8389a1503' })));
    }
    static get watchers() { return {
        "disabled": ["handlePropChange"],
        "label": ["handlePropChange"]
...
const Select = class {
    ...
    render() {
        const { disabled } = this;
        return (index.h(index.Host, { key: '80f3cb1fef4ae35fe2b6e9deb524abf4d60f62aa' }, index.h(interactive.InteractiveContainer, { key: '293fc389614ae9921328f34dafc1849bd129c6a9', disabled: disabled }, index.h("div", { key: '09f5e5312cf8ba805fec4d7c1102981890834d09', class: CSS.wrapper }, index.h("select", { key: 'cc6a95b4dc105b3e4aeec499bf6007957e22a6ec', "aria-label": label.getLabelText(this), class: CSS.select, disabled: disabled, onChange: this.handleInternalSelectChange, ref: this.storeSelectRef }, index.h("slot", { key: 'f03975d523f1bd67cbe0ac0593a2fe2397f9d129' })), this.renderChevron(), index.h(form.HiddenFormInputSlot, { key: '4f89ff06734e30f384dc900aeec831b075de1df9', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": ["valueHandler"],
