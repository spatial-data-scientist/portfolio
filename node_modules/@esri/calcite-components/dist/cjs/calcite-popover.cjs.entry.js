...
const FloatingArrow = require('./FloatingArrow-fae99de7.js');
...
const Popover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '693d249566ca53960cbfd2a5710b56c7bc239d70', "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, index.h("div", { key: '5e8b8a5c280cd88f1633787e779e063869e7f568', class: {
                [floatingUi.FloatingCSS.animation]: true,
                [floatingUi.FloatingCSS.animationActive]: displayed,
            }, ref: this.setTransitionEl }, arrowNode, index.h("div", { key: 'e30ef0aac5309e6139f6680b2b5fa8ccbf926bd8', class: {
                [CSS.hasHeader]: !!heading,
                [CSS.container]: true,
            } }, this.renderHeader(), index.h("div", { key: '77ef34667e847684b38d0b131e6340b1ba10ece3', class: CSS.content }, index.h("slot", { key: '6f8c40b34eda273acefa8f9ffdd9831726668713' })), !heading ? this.renderCloseButton() : null))));
    }
