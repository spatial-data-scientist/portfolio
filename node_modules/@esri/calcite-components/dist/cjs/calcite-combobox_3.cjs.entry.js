...
const filter = require('./filter-a1c14af9.js');
...
const debounce = require('./debounce-38e2fe81.js');
const conditionalSlot = require('./conditionalSlot-bf5cc216.js');
...
function XButton({ disabled, key, label, onClick, ref, scale, }) {
    return (index.h("button", { "aria-label": label, class: CSS$3.button, disabled: disabled, key: key, onClick: onClick, ref: ref, tabIndex: -1, type: "button" },
...
const Combobox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5739c3eb227fac2bcdf172f18cfa6c30f8e45534', onClick: this.comboboxFocusHandler }, index.h(interactive.InteractiveContainer, { key: '44b8d3b17184826dcc4777cc1c51bb36ade6c6bd', disabled: this.disabled }, index.h("div", { key: 'd60f216956651cf01f03b99127a9c580458240cf', "aria-live": "polite", class: {
                wrapper: true,
        ...
        ], index.h("label", { key: '0a225198d2f83bbabef5933e85bf4762cdd435d7', class: "screen-readers-only", htmlFor: `${inputUidPrefix}${guid}`, id: `${labelUidPrefix}${guid}` }, label), this.renderInput()), !readOnly && isClearable ? (index.h(XButton, { disabled: this.disabled, key: "close-button", label: this.messages.clear, scale: this.scale })) : null, !readOnly && this.renderChevronIcon()), index.h("ul", { key: '09bd11c770c043dab5028a004fc8c457e1452dc8', "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-multiselectable": "true", class: "screen-readers-only", id: `${listboxUidPrefix}${guid}`, role: "listbox", tabIndex: -1 }, this.renderListBoxOptions()), this.renderFloatingUIContainer(), index.h(form.HiddenFormInputSlot, { key: '157c1c6a024eeabea1692427da36e8c4f7fd45a9', component: this }), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
const ComboboxItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '24539cb8c385eba17113acbc986c5313782abc6c', "aria-hidden": "true" }, index.h(interactive.InteractiveContainer, { key: '115e856cd8a456a8d70431f87f81cae4b5ed3197', disabled: disabled }, index.h("div", { key: 'c440f95366563eddee178c1d0e89bea535699dd4', class: `container scale--${this.scale}`, style: { "--calcite-combobox-item-spacing-indent-multiplier": `${depth}` } }, index.h("li", { key: '5cce5bf58b17ff1ab86d7eb009ff3084bbf487ba', class: classes, id: this.guid, onClick: this.itemClickHandler }, this.renderSelectIndicator(showDot, iconPath), this.renderIcon(iconPath), index.h("span", { key: '6b0055d09916fe03b37d90e2d1ac5b59a47ad3bc', class: "title" }, this.renderTextContent())), this.renderChildren()))));
    }
    renderTextContent() {
