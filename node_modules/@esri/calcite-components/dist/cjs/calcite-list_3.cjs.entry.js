...
const sortableComponent = require('./sortableComponent-f4fe47b7.js');
const resources = require('./resources-9983dbb1.js');
...
const List = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: '4fb7e06d6768d6dd269f2b3e3d0db5a0b6048a6a', disabled: this.disabled }, index.h("div", { key: '5f5b87d0757b1f56d4e8b86c17d19fc57058e315', class: CSS$1.container }, this.dragEnabled ? (index.h("span", { "aria-live": "assertive", class: CSS$1.assistiveText }, this.assistiveText)) : null, this.renderItemAriaLive(), loading ? index.h("calcite-scrim", { class: CSS$1.scrim, loading: loading }) : null, index.h("table", { key: '651c93301fb891e686a13af7de6bfd05e1a91fc5', "aria-busy": dom.toAriaBoolean(loading), "aria-label": label || "", class: CSS$1.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? (index.h("thead", { class: CSS$1.sticky }, index.h("tr", null, index.h("th", { colSpan: MAX_COLUMNS }, index.h("calcite-stack", { class: CSS$1.stack }, index.h("slot", { name: SLOTS.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: resources.SLOTS.actionsStart }), index.h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, filterProps: filterProps, items: dataForFilter, onCalciteFilterChange: this.handleFilterChange, placeholder: filterPlaceholder, ref: this.setFilterEl, value: filterText }), index.h("slot", { name: SLOTS.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: resources.SLOTS.actionsEnd })))))) : null, index.h("tbody", { key: 'fb94267a3fe03d881f66c8229b914f574b50a303', class: CSS$1.tableContainer }, index.h("slot", { key: '8df0eacdb5ac1a9f2ed9b7473f3d8873f7d0460f', onSlotchange: this.handleDefaultSlotChange }))), index.h("div", { key: '0dd2a889aad47a97d19b6dd088670adc240a4060', "aria-live": "polite", "data-test-id": "no-results-container", hidden: !(hasFilterNoResults && filterEnabled && filterText && !filteredItems.length) }, index.h("slot", { key: '114e48b20ea274a1f5e25a5777d51f7425c021f1', name: SLOTS.filterNoResults, onSlotchange: this.handleFilterNoResultsSlotChange })))));
    }
    // --------------------------------------------------------------------------
    //
    //  Private Methods
...
const ListItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0ad7f6606712fcb789d833c2a8226e2492f02d9b' }, index.h(interactive.InteractiveContainer, { key: 'f908e68db67b02be4cc99007713188e28c47a4ff', disabled: disabled }, index.h("div", { key: '565126927033a03940fcc09bcf26114029ee592a', class: { [CSS$2.wrapper]: true, [CSS$2.wrapperBordered]: bordered } }, index.h("tr", { key: '8268f9c8efc3c754114ac2213d4b30dfa620897b', "aria-expanded": openable ? dom.toAriaBoolean(open) : null, "aria-label": label, "aria-level": level, "aria-posinset": setPosition, "aria-selected": dom.toAriaBoolean(selected), "aria-setsize": setSize, class: {
...
const ListItemGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '49d0c6f86c120af1e07940706ae7209d9bfe8505' }, index.h(interactive.InteractiveContainer, { key: 'ad13451f3d785e38f18ef5e70863da34e6156a92', disabled: disabled }, index.h("tr", { key: '05c409b57cfb750738bda992941ef3fa2af55e55', class: CSS.container }, index.h("td", { key: 'b55ddbc0165d0725a2ff768787956ce8a6c684ec', class: CSS.heading, colSpan: MAX_COLUMNS }, heading)), index.h("slot", { key: '9eed41b10f61dc047ded58ecb0ca5b96beac2cca', onSlotchange: this.handleDefaultSlotChange }))));
    }
    get el() { return index.getElement(this); }
};
