...
const Button = class {
    ...
    render() {
        ...
        const contentEl = (index.h("span", { key: '38df650fbf83b178f60d2df42f59d2a7aefbde30', class: CSS.content, ref: (el) => (this.contentEl = el) }, index.h("slot", { key: '5214ba6eeaedfedc6c7eb10643ecf37d8a30a651' })));
        return (index.h(interactive.InteractiveContainer, { key: 'bda810b730243b9d82c1046e5eeaf736536e5e5e', disabled: this.disabled }, index.h(Tag, { key: '9b35bb5043f98ceb94f762db9b622e7e7578c801', "aria-disabled": childElType === "a" ? dom.toAriaBoolean(this.disabled || this.loading) : null, "aria-expanded": this.el.getAttribute("aria-expanded"), "aria-label": !this.loading ? label.getLabelText(this) : this.messages.loading, "aria-live": "polite", class: {
