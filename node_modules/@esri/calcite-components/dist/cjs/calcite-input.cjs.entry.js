...
const observers = require('./observers-719bb9c5.js');
...
const Input = class {
    ...
    render() {
        ...
        const loader = (index.h("div", { key: '91ca290797296d930565c4d5c8c1c5adcfadd42f', class: CSS.loader }, index.h("calcite-progress", { key: '2721ebc8dcf7fa5dfb17455f2e7bbfd925548856', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (index.h("button", { key: '9cdd4f14b0c4128281b12fd6156e8274b579968b', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: 'cb77c42adac45d939293624cda425fa8ff1fccdc', icon: "x", scale: component.getIconScale(this.scale) })));
        const iconEl = (index.h("calcite-icon", { key: '2e285859d4f3bfaaed8ffb284ba4595d88a05a0f', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: component.getIconScale(this.scale) }));
        const isHorizontalNumberButton = this.numberButtonType === "horizontal";
        const numberButtonsHorizontalUp = (index.h("button", { key: '657b0297a616e827e7f9b4f6c216d216dd87e193', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '77a3bf36286924aafc9e3352e02acc578c3b5856', icon: "chevron-up", scale: component.getIconScale(this.scale) })));
        const numberButtonsHorizontalDown = (index.h("button", { key: '0deaf9efe2a4cb059ad24b8a2c8363ed1392726e', "aria-hidden": "true", class: {
                [CSS.numberButtonItem]: true,
                [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
            }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.numberButtonPointerDownHandler, onPointerOut: this.numberButtonPointerUpAndOutHandler, onPointerUp: this.numberButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, index.h("calcite-icon", { key: '13b751be5ad896baa26ccf6c234844b0d17abd06', icon: "chevron-down", scale: component.getIconScale(this.scale) })));
        const numberButtonsVertical = (index.h("div", { key: 'b738d15248ccf6cfe5447e1c34c9b1f65fc8a4e4', class: CSS.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown));
        const prefixText = index.h("div", { key: 'e9b94004e6a6e0d4fafebc5a2e4d75f4d4b4e216', class: CSS.prefix }, this.prefixText);
        const suffixText = index.h("div", { key: '6cbe0d708f7a3a6deac4877b868f5bef28148c01', class: CSS.suffix }, this.suffixText);
        ...
        const childEl = this.type !== "number"
            ...
            : null;
        return (index.h(index.Host, { key: 'd64b5741e88f8a1f0fa7bf57b1fcd1c653ebb4e1', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { key: 'c2a88b41ad40cc71430241b92162c39b9e95e91f', disabled: this.disabled }, index.h("div", { key: '93a830ba649218eaa1d82e5fcb6e86e9c7f1125b', class: { [CSS.inputWrapper]: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" } }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalDown
            : null, this.prefixText ? prefixText : null, index.h("div", { key: '4c0265736053dbccd3d0bca070c3b00716c1753e', class: CSS.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), index.h("div", { key: 'c3fee68974f3d04d6f843e30f598049861c9312a', class: CSS.actionWrapper }, index.h("slot", { key: '1ba027e1883626596fe1b06cb86fe3e6720c62b5', name: SLOTS.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly
            ? numberButtonsVertical
            : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
            ? numberButtonsHorizontalUp
            : null, index.h(form.HiddenFormInputSlot, { key: '2770f59360cbc7cfacb854d8b6b9345c98fa7967', component: this })), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
