...
const resources = require('./resources-efbbf154.js');
...
const Alert = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5b85226946398df7cf023211a8b358e735dd8f11', "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "calcite-hydrated-hidden": hidden, role: role }, index.h("div", { key: 'effb5efa631fc898ddec2b93950d2fbf14472d23', class: {
                [CSS.container]: true,
