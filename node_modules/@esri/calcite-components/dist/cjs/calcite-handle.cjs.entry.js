...
const Handle = class {
    ...
    render() {
        ...
        index.h("span", { key: '1b435a33669241997f126e273bd36801182a0ce5', "aria-checked": this.disabled ? null : dom.toAriaBoolean(this.selected), "aria-disabled": this.disabled ? dom.toAriaBoolean(this.disabled) : null, "aria-label": this.disabled ? null : this.getAriaText("label"), class: { [CSS.handle]: true, [CSS.handleSelected]: !this.disabled && this.selected }, onBlur: this.handleBlur, onKeyDown: this.handleKeyDown, ref: (el) => {
                this.handleButton = el;
            },
            // role of radio is being applied to allow space key to select in screen readers
            role: "radio", tabIndex: this.disabled ? null : 0, title: this.getTooltip() }, index.h("calcite-icon", { key: 'da7f46a07a28eab86153f1a04a8f82f4d7b3a0c6', icon: ICONS.drag, scale: "s" })));
    }
