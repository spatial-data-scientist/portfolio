...
const utils = require('./utils-5fafa77c.js');
...
const throttle = require('./throttle-c6911901.js');
...
const ColorPicker = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { key: 'ed8d6d887db9dc3d3e345b52b290094bde5541a8', disabled: this.disabled }, index.h("div", { key: '06f7fc8c31b3165de13f20219d7c138f162e059d', class: utils.CSS.container }, index.h("div", { key: '79d751d245545fe729cb62660436ac67589a4be8', class: utils.CSS.controlAndScope }, index.h("canvas", { key: '6fa2716d392b2f41f7c96e21d6e30c7738df4191', class: utils.CSS.colorField, onPointerDown: this.handleColorFieldPointerDown, ref: this.initColorField }), index.h("div", { key: 'c51f4c15946f87bb71674c3aadd024cbd7514d55', "aria-label": vertical ? messages.value : messages.saturation, "aria-valuemax": vertical ? utils.HSV_LIMITS.v : utils.HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color?.saturationv() : color?.value()) || "0", class: { [utils.CSS.scope]: true, [utils.CSS.colorFieldScope]: true }, onKeyDown: this.handleColorFieldScopeKeyDown, ref: this.storeColorFieldScope, role: "slider", style: {
                top: `${adjustedColorFieldScopeTop || 0}px`,
                left: `${adjustedColorFieldScopeLeft || 0}px`,
            }, tabindex: "0" })), index.h("div", { key: '6f93b38c9b16234cd5bd68edbc6c44ed4351fab4', class: utils.CSS.previewAndSliders }, index.h("calcite-color-picker-swatch", { key: 'dd12a18e453040e5af19c1e37ccbec3573cfd06b', class: utils.CSS.preview, color: selectedColorInHex, scale: this.alphaChannel ? "l" : this.scale }), index.h("div", { key: 'cf3b9c928b0d43f912726d13b584afd90f028aa5', class: utils.CSS.sliders }, index.h("div", { key: '77906dfdb66f64405ae2a62c942064d66eccf22d', class: utils.CSS.controlAndScope }, index.h("canvas", { key: '1b8ed2fd600e16ddd34c3e3d97ee7c3c3fc21125', class: { [utils.CSS.slider]: true, [utils.CSS.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown, ref: this.initHueSlider }), index.h("div", { key: '73cb98a5adfd188433c434c0f832ac660f00966f', "aria-label": messages.hue, "aria-valuemax": utils.HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || utils.DEFAULT_COLOR.round().hue(), class: { [utils.CSS.scope]: true, [utils.CSS.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, ref: this.storeHueScope, role: "slider", style: {
...
const ColorPickerHexInput = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '9939540e0bf570287d03276311c4d077e2ce1ae4', class: CSS$1.container }, index.h("calcite-input-text", { key: 'd2b6ab840fbd55bf16c6c5efe46d51e65b909cde', class: CSS$1.hexInput, label: messages?.hex || hexLabel, maxLength: 6, onCalciteInputTextChange: this.onHexInputChange, onCalciteInputTextInput: this.onHexInput, onCalciteInternalInputTextBlur: this.onHexInputBlur, onKeyDown: this.onInputKeyDown, onPaste: this.onHexInputPaste, prefixText: "#", ref: this.storeHexInputRef, scale: inputScale, value: hexInputValue }), alphaChannel ? (index.h("calcite-input-number", { class: CSS$1.opacityInput, key: "opacity-input", label: messages?.opacity, max: utils.OPACITY_LIMITS.max, maxLength: 3, min: utils.OPACITY_LIMITS.min, numberButtonType: "none", numberingSystem: this.numberingSystem, onCalciteInputNumberChange: this.onOpacityInputChange, onCalciteInternalInputNumberBlur: this.onOpacityInputBlur, onKeyDown: this.onInputKeyDown, ref: this.storeOpacityInputRef, scale: inputScale, suffixText: "%", value: opacityInputValue })) : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
