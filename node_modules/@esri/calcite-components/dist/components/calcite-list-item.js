...
import { d as slotChangeHasAssignedElement, D as getFirstTabbable, a as getElementDir, t as toAriaBoolean } from './dom.js';
...
const ListItem = /*@__PURE__*/ proxyCustomElement(class ListItem extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '0ad7f6606712fcb789d833c2a8226e2492f02d9b' }, h(InteractiveContainer, { key: 'f908e68db67b02be4cc99007713188e28c47a4ff', disabled: disabled }, h("div", { key: '565126927033a03940fcc09bcf26114029ee592a', class: { [CSS.wrapper]: true, [CSS.wrapperBordered]: bordered } }, h("tr", { key: '8268f9c8efc3c754114ac2213d4b30dfa620897b', "aria-expanded": openable ? toAriaBoolean(open) : null, "aria-label": label, "aria-level": level, "aria-posinset": setPosition, "aria-selected": toAriaBoolean(selected), "aria-setsize": setSize, class: {
                [CSS.container]: true,
