...
import { B as getElementWidth, C as getTextWidth, t as toAriaBoolean } from './dom.js';
...
function XButton({ disabled, key, label, onClick, ref, scale, }) {
    return (h("button", { "aria-label": label, class: CSS.button, disabled: disabled, key: key, onClick: onClick, ref: ref, tabIndex: -1, type: "button" },
