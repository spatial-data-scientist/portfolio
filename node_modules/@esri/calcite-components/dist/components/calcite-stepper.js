...
const Stepper = /*@__PURE__*/ proxyCustomElement(class Stepper extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '2be19afef4a5e085bfc4ea8f2f6cb65a6de83196', "aria-label": this.messages.label, role: "region" }, h("div", { key: 'e6bd09696b2dece88c200df2fcdf8b0ceadd5c8a', class: { container: true, [CSS$1.singleView]: this.layout === "horizontal-single" }, ref: this.setContainerEl }, this.layout === "horizontal-single" && (h("div", { key: 'd42d90048b6a473b84f6b9385dd096f5b4f68d55', class: { [CSS$1.stepBarContainer]: true } }, this.items.map((item, index) => (h(StepBar, { active: index === this.currentActivePosition, complete: item.complete && index !== this.currentActivePosition && !item.error, disabled: item.disabled && index !== this.currentActivePosition, error: item.error && index !== this.currentActivePosition, key: index }))))), this.layout === "horizontal-single" && (h("div", { key: '86851a89f024c1da158d2fa49e1357b5710223e9', class: { [CSS$1.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end"))), h("slot", { key: 'e635faa3273041dd35dcb4b737d2bdecf99ec639', onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
