...
const InputText = /*@__PURE__*/ proxyCustomElement(class InputText extends HTMLElement {
    ...
    render() {
        ...
        const loader = (h("div", { key: '12865e7b3c27ad8b8ea0a3dd5d1604ce3f87f5a1', class: CSS.loader }, h("calcite-progress", { key: '6bcebc67db62c8cc0c5e61855f07ea1535010fc3', label: this.messages.loading, type: "indeterminate" })));
        const inputClearButton = (h("button", { key: 'd87e649b3340823a1e2f279be9b917f67e7f86b0', "aria-label": this.messages.clear, class: CSS.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputTextValue, tabIndex: -1, type: "button" }, h("calcite-icon", { key: 'dcc3b9f506417c195827a4f05a9cc8c86a550e42', icon: "x", scale: getIconScale(this.scale) })));
        const iconEl = (h("calcite-icon", { key: '95d5ebadf61a11abaa1a18317ce8a72bf6b3c4d6', class: CSS.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) }));
        const prefixText = h("div", { key: 'c97d334f65eee3f3c72d380e893a9c98f76219e7', class: CSS.prefix }, this.prefixText);
        const suffixText = h("div", { key: 'bb784745fd1af8ddface534b720c3d4bd226115f', class: CSS.suffix }, this.suffixText);
        const childEl = (h("input", { key: '545992d12265f6db70aae39552d35d511fdebc30', "aria-label": getLabelText(this), autocomplete: this.autocomplete, autofocus: this.el.autofocus ? true : null, class: {
        ...
        return (h(Host, { key: '77abd0b127fa8a0afb9e29bf0d04cfd5dd570a74', onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: '9bd66bf7df32a0b8c6563f1f834d32dd5ed94cea', disabled: this.disabled }, h("div", { key: '15eccd86d7dd9a3af9d140bd5462f97a7427f33a', class: { [CSS.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.prefixText ? prefixText : null, h("div", { key: 'b664da42bf3e4d8d05550d324231d3bff9723dc4', class: CSS.wrapper }, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { key: '695fd376f05dec95974b7c183b404837f7bce74a', class: CSS.actionWrapper }, h("slot", { key: '59488a35e2a8de4062f87c0f73d924b86713e730', name: SLOTS.action })), this.suffixText ? suffixText : null, h(HiddenFormInputSlot, { key: '8359bd5062670af69a06b9e00d5e2dafd67c21db', component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
