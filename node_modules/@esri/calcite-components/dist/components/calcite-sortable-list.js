...
const SortableList = /*@__PURE__*/ proxyCustomElement(class SortableList extends HTMLElement {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: 'ebb128d801cf201dfdd2de2e50d287357bcc0fdb', disabled: disabled }, h("div", { key: '6d2e198ecfd8147e4d1818608a3b47dde8928647', class: {
                [CSS.container]: true,
                [CSS.containerVertical]: !horizontal,
                [CSS.containerHorizontal]: horizontal,
            } }, h("slot", { key: 'be83ec4e3b23e021b9d9a55ef4c56952128a35e7' }))));
    }
    get el() { return this; }
