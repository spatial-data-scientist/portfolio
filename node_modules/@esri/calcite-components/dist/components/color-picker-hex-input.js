...
import { c as Color, s as isLonghandHex, i as isValidHex, u as rgbToHex, n as normalizeHex, o as opacityToAlpha, a as hexify, v as hexChar, O as OPACITY_LIMITS, e as alphaToOpacity } from './utils.js';
...
const ColorPickerHexInput = /*@__PURE__*/ proxyCustomElement(class ColorPickerHexInput extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '9939540e0bf570287d03276311c4d077e2ce1ae4', class: CSS.container }, h("calcite-input-text", { key: 'd2b6ab840fbd55bf16c6c5efe46d51e65b909cde', class: CSS.hexInput, label: messages?.hex || hexLabel, maxLength: 6, onCalciteInputTextChange: this.onHexInputChange, onCalciteInputTextInput: this.onHexInput, onCalciteInternalInputTextBlur: this.onHexInputBlur, onKeyDown: this.onInputKeyDown, onPaste: this.onHexInputPaste, prefixText: "#", ref: this.storeHexInputRef, scale: inputScale, value: hexInputValue }), alphaChannel ? (h("calcite-input-number", { class: CSS.opacityInput, key: "opacity-input", label: messages?.opacity, max: OPACITY_LIMITS.max, maxLength: 3, min: OPACITY_LIMITS.min, numberButtonType: "none", numberingSystem: this.numberingSystem, onCalciteInputNumberChange: this.onOpacityInputChange, onCalciteInternalInputNumberBlur: this.onOpacityInputBlur, onKeyDown: this.onInputKeyDown, ref: this.storeOpacityInputRef, scale: inputScale, suffixText: "%", value: opacityInputValue })) : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
