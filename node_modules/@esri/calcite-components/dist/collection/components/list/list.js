...
export class List {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: '4fb7e06d6768d6dd269f2b3e3d0db5a0b6048a6a', disabled: this.disabled }, h("div", { key: '5f5b87d0757b1f56d4e8b86c17d19fc57058e315', class: CSS.container }, this.dragEnabled ? (h("span", { "aria-live": "assertive", class: CSS.assistiveText }, this.assistiveText)) : null, this.renderItemAriaLive(), loading ? h("calcite-scrim", { class: CSS.scrim, loading: loading }) : null, h("table", { key: '651c93301fb891e686a13af7de6bfd05e1a91fc5', "aria-busy": toAriaBoolean(loading), "aria-label": label || "", class: CSS.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? (h("thead", { class: CSS.sticky }, h("tr", null, h("th", { colSpan: MAX_COLUMNS }, h("calcite-stack", { class: CSS.stack }, h("slot", { name: SLOTS.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: STACK_SLOTS.actionsStart }), h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, filterProps: filterProps, items: dataForFilter, onCalciteFilterChange: this.handleFilterChange, placeholder: filterPlaceholder, ref: this.setFilterEl, value: filterText }), h("slot", { name: SLOTS.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: STACK_SLOTS.actionsEnd })))))) : null, h("tbody", { key: 'fb94267a3fe03d881f66c8229b914f574b50a303', class: CSS.tableContainer }, h("slot", { key: '8df0eacdb5ac1a9f2ed9b7473f3d8873f7d0460f', onSlotchange: this.handleDefaultSlotChange }))), h("div", { key: '0dd2a889aad47a97d19b6dd088670adc240a4060', "aria-live": "polite", "data-test-id": "no-results-container", hidden: !(hasFilterNoResults && filterEnabled && filterText && !filteredItems.length) }, h("slot", { key: '114e48b20ea274a1f5e25a5777d51f7425c021f1', name: SLOTS.filterNoResults, onSlotchange: this.handleFilterNoResultsSlotChange })))));
    }
    // --------------------------------------------------------------------------
    //
    //  Private Methods
