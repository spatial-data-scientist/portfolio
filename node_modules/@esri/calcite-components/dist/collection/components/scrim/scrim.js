...
export class Scrim {
    ...
    render() {
        ...
        return (h("div", { key: 'f2c728581805bc3a8b98931e55b4d56bc34bd3e0', class: CSS.scrim }, loading ? (h("calcite-loader", { label: messages.loading, ref: this.storeLoaderEl, scale: this.loaderScale })) : null, h("div", { key: 'eafea949b7d533d951125cae482cab4a7334c003', class: CSS.content, hidden: !hasContent }, h("slot", { key: '0eebfe6fbe3206b6f75a81086b6abb1b91ea7905', onSlotchange: this.handleDefaultSlotChange }))));
    }
    getScale(size) {
