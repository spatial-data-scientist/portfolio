...
export class CalciteNavigationLogo {
    ...
    render() {
        ...
        return (h(Host, { key: '22c239d9bd98a2f204c851939684c170c966c70f' }, h("a", { key: 'bb04b314cb0a510c5690ab1f496250716591da73', class: CSS.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && h("img", { key: '365d8955dd0486e6cc5b3bdabc232c2bbc873beb', alt: this.label || "", class: CSS.image, src: thumbnail }), this.icon && this.renderIcon(), this.renderHeaderContent())));
    }
