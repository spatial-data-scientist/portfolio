...
describe("calcite-date-picker", () => {
    ...
    it("unsetting min/max updates internally", async () => {
        const page = await newE2EPage();
        await page.emulateTimezone("America/Los_Angeles");
        await page.setContent(html `<calcite-date-picker value="2022-11-20" min="2022-11-15" max="2022-11-25"></calcite-date-picker>`);
        const element = await page.find("calcite-date-picker");
    ...
    describe("cross-century date values", () => {
        async function assertCenturyDateValue(year, timezone) {
...
async function getActiveDate(page) {
