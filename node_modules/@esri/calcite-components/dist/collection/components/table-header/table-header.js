...
export class TableHeader {
    ...
    render() {
        ...
        return (h(Host, { key: 'da0b65737ce60dcaea3f4a033e54a5adedc7a252' }, h("th", { key: 'd0a71fbe4da75f578ee69ee14782c2213acad5db', "aria-colindex": this.parentRowType === "head" ? this.positionInRow : undefined, class: {
            ...
            }, colSpan: this.colSpan, onBlur: this.onContainerBlur, onFocus: this.onContainerFocus, ref: (el) => (this.containerEl = el), role: this.parentRowType === "head" ? "columnheader" : "rowheader", rowSpan: this.rowSpan, scope: scope, tabIndex: this.selectionCell ? 0 : staticCell ? -1 : 0 }, this.heading && h("div", { key: '50b85ffe26c1b305bca0e137431be182281dc893', class: CSS.heading }, this.heading), this.description && h("div", { key: '9d51fa12b4b7f1bccf7bdc2f9899ea1d9352451c', class: CSS.description }, this.description), this.selectionCell && this.selectionMode === "multiple" && (h("calcite-icon", { key: 'fb16d491a9452f26807130358c5997ef7c437e23', class: { [CSS.active]: allSelected }, icon: selectionIcon, scale: getIconScale(this.scale) })), (this.selectionCell || this.numberCell) && (h("span", { key: '3501e1933dffbb49164e97c183e917d82be9fc87', "aria-hidden": true, "aria-live": this.focused ? "polite" : "off", class: CSS.assistiveText }, this.screenReaderText)))));
    }
