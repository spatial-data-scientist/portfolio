...
export class PickListItem {
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: 'b0a6a61daea92e2c4dc0ec2e31a6ad9c283e1727', disabled: this.disabled }, this.renderIcon(), this.renderActionsStart(), h("label", { key: 'eab25fdaee860109912439779800f89fc678f4f3', "aria-label": label, class: CSS.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, ref: (focusEl) => (this.focusEl = focusEl), tabIndex: 0 }, h("div", { key: 'e8e9ad80e3fab056e6c289d0e1a7c027be0625c8', "aria-checked": toAriaBoolean(this.selected), class: CSS.textContainer, role: "menuitemcheckbox" }, h("span", { key: '4523c6a57546d8e35284038c1988dba3838873be', class: CSS.title }, label), description ? h("span", { class: CSS.description }, description) : null)), this.renderActionsEnd()));
    }
