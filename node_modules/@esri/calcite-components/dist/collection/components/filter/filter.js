...
export class Filter {
    constructor() {
        ...
        this.filterDebounced = debounce((value, emit = false, onFilter) => this.items.length &&
            this.updateFiltered(filter(this.items, value, this.filterProps), emit, onFilter), DEBOUNCE_TIMEOUT);
    ...
    render() {
        ...
        return (h(InteractiveContainer, { key: 'f22271e30b567b7d88898e0c1c6d2131d3eecdba', disabled: disabled }, h("div", { key: 'ce9ca2a8669e825fc0a9bb6bbb64e14054e80308', class: CSS.container }, h("label", { key: '031e40138a6dc0c2ad814e73e2fd7e24ea03f017' }, h("calcite-input", { key: 'd66d58ea14ed30279b8b2ea063651a53d4cf0a0d', clearable: true, disabled: disabled, icon: ICONS.search, label: this.messages.label, messageOverrides: { clear: this.messages.clear }, onCalciteInputInput: this.inputHandler, onKeyDown: this.keyDownHandler, placeholder: this.placeholder, ref: (el) => {
                this.textInput = el;
