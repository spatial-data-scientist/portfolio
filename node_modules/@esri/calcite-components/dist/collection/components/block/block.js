...
export class Block {
    ...
    render() {
        ...
        const headerContent = (h("header", { key: '09de168983611cb923294443ec7a89942133e767', class: CSS.header, id: IDS.header }, this.renderIcon("start"), this.renderContentStart(), this.renderLoaderStatusIcon(), this.renderTitle()));
        const hasControl = !!getSlotted(el, SLOTS.control);
        const hasMenuActions = !!getSlotted(el, SLOTS.headerMenuActions);
        const collapseIcon = open ? ICONS.opened : ICONS.closed;
        const headerNode = (h("div", { key: '2c03c73685db7feb04844be8f0b308add3eb2aa6', class: CSS.headerContainer }, this.dragHandle ? h("calcite-handle", { label: heading }) : null, collapsible ? (h("button", { "aria-controls": IDS.content, "aria-describedby": IDS.header, "aria-expanded": collapsible ? toAriaBoolean(open) : null, class: CSS.toggle, id: IDS.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, h("div", { class: CSS.iconEndContainer }, this.renderIcon("end"), h("calcite-icon", { class: CSS.toggleIcon, icon: collapseIcon, scale: "s" })))) : this.iconEnd ? (h("div", null, headerContent, h("div", { class: CSS.iconEndContainer }, this.renderIcon("end")))) : (headerContent), hasControl ? (h("div", { "aria-labelledby": IDS.header, class: CSS.controlContainer }, h("slot", { name: SLOTS.control }))) : null, hasMenuActions ? (h("calcite-action-menu", { label: messages.options, overlayPositioning: this.overlayPositioning }, h("slot", { name: SLOTS.headerMenuActions }))) : null, this.renderActionsEnd()));
        return (h(Host, { key: 'e33a4f97740d5e0f6d41d5014546925c3637c40b' }, h(InteractiveContainer, { key: '88b24fc8283f230feccc910b9925fc9d6a23ae55', disabled: this.disabled }, h("article", { key: '81e09b5a468cffcd68414ad518b69bd2ef56189c', "aria-busy": toAriaBoolean(loading), class: {
                [CSS.container]: true,
            } }, headerNode, h("section", { key: '44d82173efbdbeec15dbf3f7a9ec191bc2d17a11', "aria-labelledby": IDS.toggle, class: CSS.content, hidden: !open, id: IDS.content, ref: this.setTransitionEl }, this.renderScrim())))));
    }
