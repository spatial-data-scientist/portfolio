  ...
  `;
    ...
    `;
        it("should filter on initial load", async () => {
            ...
            await page.waitForChanges();
            const visibleItemsAndGroups = await page.findAll("calcite-combobox-item:not([hidden]), calcite-combobox-item-group:not([hidden])");
        ...
        it("should display all groups/items when filter is cleared", async () => {
            ...
            await page.waitForChanges();
            const filteredItemsAndGroups = await page.findAll("calcite-combobox-item:not([hidden]), calcite-combobox-item-group:not([hidden])");
            ...
            await page.waitForChanges();
            const allVisibleItemAndGroups = await page.findAll("calcite-combobox-item:not([hidden]), calcite-combobox-item-group:not([hidden])");
    ...
    describe("keyboard navigation with chips", () => {
      ...
      `);
        ...
        it("should navigate chips and text with arrow keys", async () => {
            ...
            const getDataTestId = () => page.$eval(`#${comboboxId}`, (myCombobox) => myCombobox.shadowRoot.activeElement.getAttribute("data-test-id"));
